package Aws::EC2::RequestSpotLaunchSpecification {
  use Moose;
  ...
  has NetworkInterfaces => (is => 'ro', isa => 'ArrayRef[Aws::EC2::InstanceNetworkInterfaceSpecification]', traits => ['Unwrapped'], xmlname => 'NetworkInterface');
