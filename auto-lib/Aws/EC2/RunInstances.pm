...
package Aws::EC2::RunInstances {
  ...
  has IamInstanceProfile => (is => 'ro', isa => 'Aws::EC2::IamInstanceProfileSpecification', traits => ['NameInRequest'], request_name => 'iamInstanceProfile' );
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Aws::EC2::Reservation');
