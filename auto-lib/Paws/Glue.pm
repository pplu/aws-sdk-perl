...
=item InputRecordTables => ArrayRef[Glue_GlueTable]

=item Name => Str

=item Parameters => Glue_TransformParameters
...
=item [Filter => Glue_TaskRunFilterCriteria]

=item [MaxResults => Int]

=item [NextToken => Str]

=item [Sort => Glue_TaskRunSortCriteria]
...
=item [Filter => Glue_TransformFilterCriteria]

=item [MaxResults => Int]

=item [NextToken => Str]

=item [Sort => Glue_TransformSortCriteria]
...
=item [Filters => ArrayRef[Glue_PropertyPredicate]]
...
=item [SortCriteria => ArrayRef[Glue_SortCriterion]]
