...
Paws::AutoScaling::DescribeScalingProcessTypes - Arguments for method DescribeScalingProcessTypes on Paws::AutoScaling
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeScalingProcessTypes.

As an example:

  $service_obj->DescribeScalingProcessTypes(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeScalingProcessTypes in Paws::AutoScaling
