...
Paws::AutoScaling::DescribeLifecycleHookTypes - Arguments for method DescribeLifecycleHookTypes on Paws::AutoScaling
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeLifecycleHookTypes.

As an example:

  $service_obj->DescribeLifecycleHookTypes(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeLifecycleHookTypes in Paws::AutoScaling
