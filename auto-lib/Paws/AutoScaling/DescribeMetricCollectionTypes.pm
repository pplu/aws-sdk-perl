...
Paws::AutoScaling::DescribeMetricCollectionTypes - Arguments for method DescribeMetricCollectionTypes on Paws::AutoScaling
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeMetricCollectionTypes.

As an example:

  $service_obj->DescribeMetricCollectionTypes(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeMetricCollectionTypes in Paws::AutoScaling
