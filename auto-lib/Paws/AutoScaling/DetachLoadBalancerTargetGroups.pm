...
package Paws::AutoScaling::DetachLoadBalancerTargetGroups;
  ...
  has TargetGroupARNs => (is => 'ro', isa => 'ArrayRef[Str]', required => 1);
...
Paws::AutoScaling::DetachLoadBalancerTargetGroups - Arguments for method DetachLoadBalancerTargetGroups on Paws::AutoScaling
...
As an example:
  ...
  $service_obj->DetachLoadBalancerTargetGroups(Att1 => $value1, Att2 => $value2, ...);
...
=head2 B<REQUIRED> TargetGroupARNs => ArrayRef[Str]
