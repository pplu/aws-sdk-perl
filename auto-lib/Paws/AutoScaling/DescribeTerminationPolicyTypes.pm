...
Paws::AutoScaling::DescribeTerminationPolicyTypes - Arguments for method DescribeTerminationPolicyTypes on Paws::AutoScaling
...
As an example:
  ...
  $service_obj->DescribeTerminationPolicyTypes(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeTerminationPolicyTypes in Paws::AutoScaling
