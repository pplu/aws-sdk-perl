...
package Paws::AutoScaling::CreateOrUpdateTags;
  ...
  use Paws::AutoScaling::Types qw/AutoScaling_Tag/;
  has Tags => (is => 'ro', isa => ArrayRef[AutoScaling_Tag], required => 1, predicate => 1);
...
=head2 B<REQUIRED> Tags => ArrayRef[AutoScaling_Tag]
