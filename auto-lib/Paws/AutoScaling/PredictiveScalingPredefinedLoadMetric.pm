...
package Paws::AutoScaling::PredictiveScalingPredefinedLoadMetric;
  use Moose;
...
Paws::AutoScaling::PredictiveScalingPredefinedLoadMetric
...
As an example, if Att1 is expected to be a Paws::AutoScaling::PredictiveScalingPredefinedLoadMetric object:

  $service_obj->Method(Att1 => { PredefinedMetricType => $value, ..., ResourceLabel => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AutoScaling::PredictiveScalingPredefinedLoadMetric object:
