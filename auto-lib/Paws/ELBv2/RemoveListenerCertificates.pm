...
Paws::ELBv2::RemoveListenerCertificates - Arguments for method RemoveListenerCertificates on Paws::ELBv2
...
As an example:
  ...
  $service_obj->RemoveListenerCertificates(Att1 => $value1, Att2 => $value2, ...);
