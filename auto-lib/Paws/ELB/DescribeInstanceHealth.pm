...
Paws::ELB::DescribeInstanceHealth - Arguments for method DescribeInstanceHealth on Paws::ELB
...
This class forms part of L<Paws>, and documents parameters for DescribeInstanceHealth in Paws::ELB
