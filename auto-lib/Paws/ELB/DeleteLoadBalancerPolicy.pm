...
Paws::ELB::DeleteLoadBalancerPolicy - Arguments for method DeleteLoadBalancerPolicy on Paws::ELB
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteLoadBalancerPolicy.

As an example:

  $service_obj->DeleteLoadBalancerPolicy(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteLoadBalancerPolicy in Paws::ELB
