...
Paws::ELB::DescribeTags - Arguments for method DescribeTags on Paws::ELB
...
This class forms part of L<Paws>, and documents parameters for DescribeTags in Paws::ELB
