...
Paws::Route53Domains::ListTagsForDomain - Arguments for method ListTagsForDomain on Paws::Route53Domains
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to ListTagsForDomain.

As an example:

  $service_obj->ListTagsForDomain(Att1 => $value1, Att2 => $value2, ...);
