...
Paws::Route53Domains::GetContactReachabilityStatus - Arguments for method GetContactReachabilityStatus on Paws::Route53Domains
...
As an example:
  ...
  $service_obj->GetContactReachabilityStatus(Att1 => $value1, Att2 => $value2, ...);
