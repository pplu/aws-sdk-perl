...
Paws::Route53Domains::ResendContactReachabilityEmail - Arguments for method ResendContactReachabilityEmail on Paws::Route53Domains
...
As an example:
  ...
  $service_obj->ResendContactReachabilityEmail(Att1 => $value1, Att2 => $value2, ...);
