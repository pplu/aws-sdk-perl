...
Paws::Route53Domains::DisableDomainTransferLock - Arguments for method DisableDomainTransferLock on Paws::Route53Domains
...
As an example:
  ...
  $service_obj->DisableDomainTransferLock(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DisableDomainTransferLock in Paws::Route53Domains
