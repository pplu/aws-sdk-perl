...
Paws::Kinesis::ResourceNotFoundException
...
As an example, if Att1 is expected to be a Paws::Kinesis::ResourceNotFoundException object:

  $service_obj->Method(Att1 => { Message => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Kinesis::ResourceNotFoundException object:
