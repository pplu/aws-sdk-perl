...
shard. Specifically, an MD5 hash function is used to map partition keys
...
record I<n-1> (as returned in the PutRecordResult when putting record
I<n-1>). If this parameter is not set, records will be coarsely ordered
