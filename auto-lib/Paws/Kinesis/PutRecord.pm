...
package Paws::Kinesis::PutRecord;
  ...
  has Data => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has ExplicitHashKey => (is => 'ro', isa => Str, predicate => 1);
  has PartitionKey => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has SequenceNumberForOrdering => (is => 'ro', isa => Str, predicate => 1);
