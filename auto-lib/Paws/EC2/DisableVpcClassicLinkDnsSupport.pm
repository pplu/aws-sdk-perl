...
Paws::EC2::DisableVpcClassicLinkDnsSupport - Arguments for method DisableVpcClassicLinkDnsSupport on Paws::EC2
...
As an example:
  ...
  $service_obj->DisableVpcClassicLinkDnsSupport(Att1 => $value1, Att2 => $value2, ...);
