...
package Paws::EC2::DescribeSpotFleetRequestHistoryResponse;
  ...
  has LastEvaluatedTime => (is => 'ro', isa => 'Paws::API::TimeStamp', xmlname => 'lastEvaluatedTime', traits => ['Unwrapped',], required => 1);
  has NextToken => (is => 'ro', isa => 'Str', xmlname => 'nextToken', traits => ['Unwrapped',]);
  has SpotFleetRequestId => (is => 'ro', isa => 'Str', xmlname => 'spotFleetRequestId', traits => ['Unwrapped',], required => 1);
  has StartTime => (is => 'ro', isa => 'Paws::API::TimeStamp', xmlname => 'startTime', traits => ['Unwrapped',], required => 1);
...
=head2 B<REQUIRED> LastEvaluatedTime => L<Paws::API::TimeStamp>
