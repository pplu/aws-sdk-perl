...
Paws::EC2::DeleteInternetGateway - Arguments for method DeleteInternetGateway on Paws::EC2
...
As an example:
  ...
  $service_obj->DeleteInternetGateway(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteInternetGateway in Paws::EC2
