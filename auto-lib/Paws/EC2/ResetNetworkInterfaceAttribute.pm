...
package Paws::EC2::ResetNetworkInterfaceAttribute;
  ...
  has SourceDestCheck => (is => 'ro', isa => Str, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/ResetNetworkInterfaceAttribute>
