...
Paws::EC2::InternetGatewayAttachment
...
As an example, if Att1 is expected to be a Paws::EC2::InternetGatewayAttachment object:

  $service_obj->Method(Att1 => { State => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::InternetGatewayAttachment object:
