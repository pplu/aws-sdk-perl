...
Paws::EC2::DeleteVpcPeeringConnection - Arguments for method DeleteVpcPeeringConnection on Paws::EC2
...
As an example:
  ...
  $service_obj->DeleteVpcPeeringConnection(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteVpcPeeringConnection in Paws::EC2
