...
Paws::EC2::TransitGatewayAssociation
...
As an example, if Att1 is expected to be a Paws::EC2::TransitGatewayAssociation object:

  $service_obj->Method(Att1 => { ResourceId => $value, ..., TransitGatewayRouteTableId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::TransitGatewayAssociation object:
