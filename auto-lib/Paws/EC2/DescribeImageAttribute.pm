...
Paws::EC2::DescribeImageAttribute - Arguments for method DescribeImageAttribute on Paws::EC2
...
As an example:
  ...
  $service_obj->DescribeImageAttribute(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeImageAttribute in Paws::EC2
