...
package Paws::EC2::ModifySpotFleetRequest;
  ...
  has OnDemandTargetCapacity => (is => 'ro', isa => Int, predicate => 1);
  has SpotFleetRequestId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has TargetCapacity => (is => 'ro', isa => Int, predicate => 1);
