package Paws::EC2::LaunchTemplateCapacityReservationSpecificationResponse;
  use Moose;
...
Paws::EC2::LaunchTemplateCapacityReservationSpecificationResponse
...
As an example, if Att1 is expected to be a Paws::EC2::LaunchTemplateCapacityReservationSpecificationResponse object:

  $service_obj->Method(Att1 => { CapacityReservationPreference => $value, ..., CapacityReservationTarget => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LaunchTemplateCapacityReservationSpecificationResponse object:
