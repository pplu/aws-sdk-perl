...
Paws::EC2::CreateInstanceExportTask - Arguments for method CreateInstanceExportTask on Paws::EC2
...
As an example:
  ...
  $service_obj->CreateInstanceExportTask(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for CreateInstanceExportTask in Paws::EC2
