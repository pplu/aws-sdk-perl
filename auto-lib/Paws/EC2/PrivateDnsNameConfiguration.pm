package Paws::EC2::PrivateDnsNameConfiguration;
  use Moose;
...
Paws::EC2::PrivateDnsNameConfiguration
...
As an example, if Att1 is expected to be a Paws::EC2::PrivateDnsNameConfiguration object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::PrivateDnsNameConfiguration object:
