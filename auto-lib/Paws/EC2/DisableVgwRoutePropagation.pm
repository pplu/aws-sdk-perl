...
Paws::EC2::DisableVgwRoutePropagation - Arguments for method DisableVgwRoutePropagation on Paws::EC2
...
As an example:
  ...
  $service_obj->DisableVgwRoutePropagation(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DisableVgwRoutePropagation in Paws::EC2
