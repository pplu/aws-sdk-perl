...
Paws::EC2::AssociateRouteTable - Arguments for method AssociateRouteTable on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to AssociateRouteTable.
...
This class forms part of L<Paws>, and documents parameters for AssociateRouteTable in Paws::EC2
