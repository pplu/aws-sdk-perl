...
Paws::EC2::MoveAddressToVpc - Arguments for method MoveAddressToVpc on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to MoveAddressToVpc.
