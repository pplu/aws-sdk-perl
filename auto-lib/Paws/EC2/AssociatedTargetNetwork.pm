...
Paws::EC2::AssociatedTargetNetwork
...
As an example, if Att1 is expected to be a Paws::EC2::AssociatedTargetNetwork object:

  $service_obj->Method(Att1 => { NetworkId => $value, ..., NetworkType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::AssociatedTargetNetwork object:
