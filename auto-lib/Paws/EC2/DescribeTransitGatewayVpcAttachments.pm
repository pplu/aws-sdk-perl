...
C<transit-gateway-attachment-state> - The state of the attachment
(C<pendingAcceptance> | C<pending> | C<available> | C<modifying> |
C<deleting> | C<deleted> | C<failed> | C<rejected>).
