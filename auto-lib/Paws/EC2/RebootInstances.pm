...
Paws::EC2::RebootInstances - Arguments for method RebootInstances on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to RebootInstances.
