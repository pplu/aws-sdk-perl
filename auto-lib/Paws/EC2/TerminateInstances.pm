...
Paws::EC2::TerminateInstances - Arguments for method TerminateInstances on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to TerminateInstances.

As an example:

  $service_obj->TerminateInstances(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for TerminateInstances in Paws::EC2
