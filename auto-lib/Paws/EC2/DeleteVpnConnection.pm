...
Paws::EC2::DeleteVpnConnection - Arguments for method DeleteVpnConnection on Paws::EC2
...
As an example:
  ...
  $service_obj->DeleteVpnConnection(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteVpnConnection in Paws::EC2
