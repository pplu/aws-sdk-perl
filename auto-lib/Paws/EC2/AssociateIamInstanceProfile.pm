...
Paws::EC2::AssociateIamInstanceProfile - Arguments for method AssociateIamInstanceProfile on Paws::EC2
...
As an example:
  ...
  $service_obj->AssociateIamInstanceProfile(Att1 => $value1, Att2 => $value2, ...);
