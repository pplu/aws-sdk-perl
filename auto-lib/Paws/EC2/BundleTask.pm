package Paws::EC2::BundleTask {
  ...
  has BundleTaskError => (is => 'ro', isa => 'Paws::EC2::BundleTaskError', traits => ['Unwrapped'], xmlname => 'error');
  ...
  has Storage => (is => 'ro', isa => 'Paws::EC2::Storage', traits => ['Unwrapped'], xmlname => 'storage');
