package Paws::EC2::ExportTask {
  ...
  has ExportToS3Task => (is => 'ro', isa => 'Paws::EC2::ExportToS3Task', traits => ['Unwrapped'], xmlname => 'exportToS3');
  has InstanceExportDetails => (is => 'ro', isa => 'Paws::EC2::InstanceExportDetails', traits => ['Unwrapped'], xmlname => 'instanceExport');
