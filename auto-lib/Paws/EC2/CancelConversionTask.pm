...
Paws::EC2::CancelConversionTask - Arguments for method CancelConversionTask on Paws::EC2
...
As an example:
  ...
  $service_obj->CancelConversionTask(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for CancelConversionTask in Paws::EC2
