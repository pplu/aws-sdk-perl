...
Paws::EC2::DetachClassicLinkVpc - Arguments for method DetachClassicLinkVpc on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DetachClassicLinkVpc.

As an example:

  $service_obj->DetachClassicLinkVpc(Att1 => $value1, Att2 => $value2, ...);
