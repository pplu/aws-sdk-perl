...
Paws::EC2::DeleteKeyPair - Arguments for method DeleteKeyPair on Paws::EC2
...
This class forms part of L<Paws>, and documents parameters for DeleteKeyPair in Paws::EC2
