package Paws::EC2::SpotInstanceRequest {
  ...
  has LaunchSpecification => (is => 'ro', isa => 'Paws::EC2::LaunchSpecification', traits => ['Unwrapped'], xmlname => 'launchSpecification');
  ...
  has Status => (is => 'ro', isa => 'Paws::EC2::SpotInstanceStatus', traits => ['Unwrapped'], xmlname => 'status');
