...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteVpc.
...
This class forms part of L<Paws>, and documents parameters for DeleteVpc in Paws::EC2
