package Paws::EC2::ReservedInstancesListing {
  ...
  has InstanceCounts => (is => 'ro', isa => 'ArrayRef[Paws::EC2::InstanceCount]', traits => ['Unwrapped'], xmlname => 'instanceCounts');
  has PriceSchedules => (is => 'ro', isa => 'ArrayRef[Paws::EC2::PriceSchedule]', traits => ['Unwrapped'], xmlname => 'priceSchedules');
