...
Paws::EC2::CreateNetworkAcl - Arguments for method CreateNetworkAcl on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to CreateNetworkAcl.
...
This class forms part of L<Paws>, and documents parameters for CreateNetworkAcl in Paws::EC2
