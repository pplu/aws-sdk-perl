...
Paws::EC2::MonitorInstances - Arguments for method MonitorInstances on Paws::EC2
...
This class forms part of L<Paws>, and documents parameters for MonitorInstances in Paws::EC2
