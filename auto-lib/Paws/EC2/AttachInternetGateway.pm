...
Paws::EC2::AttachInternetGateway - Arguments for method AttachInternetGateway on Paws::EC2
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to AttachInternetGateway.

As an example:

  $service_obj->AttachInternetGateway(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for AttachInternetGateway in Paws::EC2
