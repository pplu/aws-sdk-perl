...
Paws::SSM::DescribeMaintenanceWindowExecutionTasks - Arguments for method DescribeMaintenanceWindowExecutionTasks on Paws::SSM
...
As an example:
  ...
  $service_obj->DescribeMaintenanceWindowExecutionTasks(Att1 => $value1, Att2 => $value2, ...);
