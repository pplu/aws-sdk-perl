...
Paws::SSM::UpdateManagedInstanceRole - Arguments for method UpdateManagedInstanceRole on Paws::SSM
...
As an example:
  ...
  $service_obj->UpdateManagedInstanceRole(Att1 => $value1, Att2 => $value2, ...);
