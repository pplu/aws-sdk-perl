...
Paws::SSM::DescribeDocumentPermission - Arguments for method DescribeDocumentPermission on Paws::SSM
...
As an example:
  ...
  $service_obj->DescribeDocumentPermission(Att1 => $value1, Att2 => $value2, ...);
