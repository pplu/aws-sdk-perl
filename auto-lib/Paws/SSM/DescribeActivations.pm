...
package Paws::SSM::DescribeActivations;
  ...
  use Paws::SSM::Types qw/SSM_DescribeActivationsFilter/;
  has Filters => (is => 'ro', isa => ArrayRef[SSM_DescribeActivationsFilter], predicate => 1);
  ...
  'types' => {
               ...
               'Filters' => {
                              'class' => 'Paws::SSM::DescribeActivationsFilter',
                              'type' => 'ArrayRef[SSM_DescribeActivationsFilter]'
                            },
               'MaxResults' => {
                                 'type' => 'Int'
                               }
...
=head2 Filters => ArrayRef[SSM_DescribeActivationsFilter]
