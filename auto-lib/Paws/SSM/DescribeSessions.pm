...
package Paws::SSM::DescribeSessions;
  ...
  use Paws::SSM::Types qw/SSM_SessionFilter/;
  has Filters => (is => 'ro', isa => ArrayRef[SSM_SessionFilter], predicate => 1);
  ...
  'types' => {
               'Filters' => {
                              'type' => 'ArrayRef[SSM_SessionFilter]',
                              'class' => 'Paws::SSM::SessionFilter'
                            },
               'State' => {
                            'type' => 'Str'
                          },
...
=head2 Filters => ArrayRef[SSM_SessionFilter]
