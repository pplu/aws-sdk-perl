...
package Paws::SSM::ListAssociations;
  ...
  use Paws::SSM::Types qw/SSM_AssociationFilter/;
  has AssociationFilterList => (is => 'ro', isa => ArrayRef[SSM_AssociationFilter], predicate => 1);
  ...
  'types' => {
               ...
               'AssociationFilterList' => {
                                            'class' => 'Paws::SSM::AssociationFilter',
                                            'type' => 'ArrayRef[SSM_AssociationFilter]'
                                          },
               'MaxResults' => {
                                 'type' => 'Int'
                               }
...
=head2 AssociationFilterList => ArrayRef[SSM_AssociationFilter]
