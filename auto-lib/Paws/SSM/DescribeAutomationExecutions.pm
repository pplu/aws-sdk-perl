...
Paws::SSM::DescribeAutomationExecutions - Arguments for method DescribeAutomationExecutions on Paws::SSM
...
As an example:
  ...
  $service_obj->DescribeAutomationExecutions(Att1 => $value1, Att2 => $value2, ...);
