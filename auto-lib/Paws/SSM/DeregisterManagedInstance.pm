...
Paws::SSM::DeregisterManagedInstance - Arguments for method DeregisterManagedInstance on Paws::SSM
...
As an example:
  ...
  $service_obj->DeregisterManagedInstance(Att1 => $value1, Att2 => $value2, ...);
