...
Paws::DynamoDB::DeleteTable - Arguments for method DeleteTable on Paws::DynamoDB
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteTable.
...
This class forms part of L<Paws>, and documents parameters for DeleteTable in Paws::DynamoDB
