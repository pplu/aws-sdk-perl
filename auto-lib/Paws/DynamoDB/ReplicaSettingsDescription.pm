...
package Paws::DynamoDB::ReplicaSettingsDescription;
  ...
  use Paws::DynamoDB::Types qw/DynamoDB_AutoScalingSettingsDescription DynamoDB_ReplicaGlobalSecondaryIndexSettingsDescription DynamoDB_BillingModeSummary/;
