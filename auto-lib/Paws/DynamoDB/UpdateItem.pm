...
package Paws::DynamoDB::UpdateItem;
  ...
  use Paws::DynamoDB::Types qw/DynamoDB_ExpectedAttributeMap DynamoDB_AttributeUpdates DynamoDB_Key DynamoDB_ExpressionAttributeValueMap DynamoDB_ExpressionAttributeNameMap/;
