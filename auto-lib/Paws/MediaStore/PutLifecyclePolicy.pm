...
package Paws::MediaStore::PutLifecyclePolicy;
  ...
  has LifecyclePolicy => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediastore/PutLifecyclePolicy>
