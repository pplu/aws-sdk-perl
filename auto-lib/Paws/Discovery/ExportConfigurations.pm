...
Paws::Discovery::ExportConfigurations - Arguments for method ExportConfigurations on Paws::Discovery
...
As an example:
  ...
  $service_obj->ExportConfigurations(Att1 => $value1, Att2 => $value2, ...);
