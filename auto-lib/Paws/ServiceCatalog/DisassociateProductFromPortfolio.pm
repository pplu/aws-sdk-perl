...
Paws::ServiceCatalog::DisassociateProductFromPortfolio - Arguments for method DisassociateProductFromPortfolio on Paws::ServiceCatalog
...
As an example:
  ...
  $service_obj->DisassociateProductFromPortfolio(Att1 => $value1, Att2 => $value2, ...);
