...
Paws::ServiceCatalog::AcceptPortfolioShare - Arguments for method AcceptPortfolioShare on Paws::ServiceCatalog
...
As an example:
  ...
  $service_obj->AcceptPortfolioShare(Att1 => $value1, Att2 => $value2, ...);
