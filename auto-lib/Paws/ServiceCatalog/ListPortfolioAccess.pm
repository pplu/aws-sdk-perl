...
Paws::ServiceCatalog::ListPortfolioAccess - Arguments for method ListPortfolioAccess on Paws::ServiceCatalog
...
As an example:
  ...
  $service_obj->ListPortfolioAccess(Att1 => $value1, Att2 => $value2, ...);
