...
Paws::KMS::DisableKey - Arguments for method DisableKey on Paws::KMS
...
As an example:
  ...
  $service_obj->DisableKey(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DisableKey in Paws::KMS
