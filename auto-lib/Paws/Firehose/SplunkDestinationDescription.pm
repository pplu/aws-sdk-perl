...
package Paws::Firehose::SplunkDestinationDescription;
  ...
  use Paws::Firehose::Types qw/Firehose_SplunkRetryOptions Firehose_S3DestinationDescription Firehose_CloudWatchLoggingOptions Firehose_ProcessingConfiguration/;
