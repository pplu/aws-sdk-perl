...
Paws::Firehose::DeleteDeliveryStream - Arguments for method DeleteDeliveryStream on Paws::Firehose
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteDeliveryStream.

As an example:

  $service_obj->DeleteDeliveryStream(Att1 => $value1, Att2 => $value2, ...);
