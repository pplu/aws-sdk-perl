...
package Paws::Firehose::SplunkDestinationUpdate;
  ...
  use Paws::Firehose::Types qw/Firehose_S3DestinationUpdate Firehose_ProcessingConfiguration Firehose_CloudWatchLoggingOptions Firehose_SplunkRetryOptions/;
