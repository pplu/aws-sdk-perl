...
package Paws::Firehose::SplunkDestinationUpdate;
  ...
  use Paws::Firehose::Types qw/Firehose_ProcessingConfiguration Firehose_S3DestinationUpdate Firehose_CloudWatchLoggingOptions Firehose_SplunkRetryOptions/;
