...
package Paws::Appflow::ServiceNowConnectorProfileProperties;
  use Moose;
...
Paws::Appflow::ServiceNowConnectorProfileProperties
...
As an example, if Att1 is expected to be a Paws::Appflow::ServiceNowConnectorProfileProperties object:

  $service_obj->Method(Att1 => { InstanceUrl => $value, ..., InstanceUrl => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Appflow::ServiceNowConnectorProfileProperties object:
