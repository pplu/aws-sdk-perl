...
package Paws::Appflow::VeevaConnectorProfileCredentials;
  use Moose;
...
Paws::Appflow::VeevaConnectorProfileCredentials
...
As an example, if Att1 is expected to be a Paws::Appflow::VeevaConnectorProfileCredentials object:

  $service_obj->Method(Att1 => { Password => $value, ..., Username => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Appflow::VeevaConnectorProfileCredentials object:
