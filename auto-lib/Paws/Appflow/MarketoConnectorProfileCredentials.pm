...
package Paws::Appflow::MarketoConnectorProfileCredentials;
  use Moose;
...
Paws::Appflow::MarketoConnectorProfileCredentials
...
As an example, if Att1 is expected to be a Paws::Appflow::MarketoConnectorProfileCredentials object:

  $service_obj->Method(Att1 => { AccessToken => $value, ..., OAuthRequest => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Appflow::MarketoConnectorProfileCredentials object:
