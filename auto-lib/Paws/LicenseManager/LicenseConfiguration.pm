...
package Paws::LicenseManager::LicenseConfiguration;
  use Moo;
  use Types::Standard qw/Int ArrayRef Str Bool Undef/;
  use Paws::LicenseManager::Types qw/LicenseManager_ConsumedLicenseSummary LicenseManager_ManagedResourceSummary/;
