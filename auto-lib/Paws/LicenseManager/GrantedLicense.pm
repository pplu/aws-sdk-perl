...
package Paws::LicenseManager::GrantedLicense;
  use Moose;
  ...
  has ReceivedMetadata => (is => 'ro', isa => 'Paws::LicenseManager::ReceivedMetadata');
...
Paws::LicenseManager::GrantedLicense
...
As an example, if Att1 is expected to be a Paws::LicenseManager::GrantedLicense object:

  $service_obj->Method(Att1 => { Beneficiary => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LicenseManager::GrantedLicense object:
...
=head2 ReceivedMetadata => L<Paws::LicenseManager::ReceivedMetadata>
