...
Paws::SageMakerA2IRuntime::HumanReviewDataAttributes
...
As an example, if Att1 is expected to be a Paws::SageMakerA2IRuntime::HumanReviewDataAttributes object:

  $service_obj->Method(Att1 => { ContentClassifiers => $value, ..., ContentClassifiers => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMakerA2IRuntime::HumanReviewDataAttributes object:
...
=head2 B<REQUIRED> ContentClassifiers => ArrayRef[Str|Undef]
