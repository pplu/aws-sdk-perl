...
Paws::DirectConnect::DeleteVirtualInterface - Arguments for method DeleteVirtualInterface on Paws::DirectConnect
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteVirtualInterface.

As an example:

  $service_obj->DeleteVirtualInterface(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteVirtualInterface in Paws::DirectConnect
