...
Paws::DirectConnect::DescribeLocations - Arguments for method DescribeLocations on Paws::DirectConnect
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeLocations.
...
This class forms part of L<Paws>, and documents parameters for DescribeLocations in Paws::DirectConnect
