...
Paws::DirectConnect::DeleteConnection - Arguments for method DeleteConnection on Paws::DirectConnect
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteConnection.

As an example:

  $service_obj->DeleteConnection(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteConnection in Paws::DirectConnect
