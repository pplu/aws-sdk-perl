...
Paws::DirectConnect::CreateDirectConnectGatewayAssociation - Arguments for method CreateDirectConnectGatewayAssociation on Paws::DirectConnect
...
As an example:
  ...
  $service_obj->CreateDirectConnectGatewayAssociation(Att1 => $value1, Att2 => $value2, ...);
