...
Paws::DirectConnect::ConfirmConnection - Arguments for method ConfirmConnection on Paws::DirectConnect
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to ConfirmConnection.

As an example:

  $service_obj->ConfirmConnection(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for ConfirmConnection in Paws::DirectConnect
