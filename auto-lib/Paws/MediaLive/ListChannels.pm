...
package Paws::MediaLive::ListChannels;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaLive::ListChannelsResponse');
1;
...
Paws::MediaLive::ListChannels - Arguments for method ListChannels on L<Paws::MediaLive>
...
=head1 SYNOPSIS
    ...
    my $ListChannelsResponse = $medialive->ListChannels(
    ...
    # Returns a L<Paws::MediaLive::ListChannelsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/medialive/ListChannels>
...
This class forms part of L<Paws>, documenting arguments for method ListChannels in L<Paws::MediaLive>
