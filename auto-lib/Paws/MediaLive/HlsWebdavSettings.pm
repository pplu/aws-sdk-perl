...
Paws::MediaLive::HlsWebdavSettings
...
As an example, if Att1 is expected to be a Paws::MediaLive::HlsWebdavSettings object:

  $service_obj->Method(Att1 => { ConnectionRetryInterval => $value, ..., RestartDelay => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::HlsWebdavSettings object:
