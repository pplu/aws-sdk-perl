...
Paws::MediaLive::DeleteInput - Arguments for method DeleteInput on L<Paws::MediaLive>
...
As an example:
  ...
  $service_obj->DeleteInput(Att1 => $value1, Att2 => $value2, ...);

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/medialive/DeleteInput>
=head1 ATTRIBUTES
...
This class forms part of L<Paws>, documenting arguments for method DeleteInput in L<Paws::MediaLive>
