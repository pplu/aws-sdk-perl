...
package Paws::MediaLive::DeleteSchedule;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaLive::DeleteScheduleResponse');
1;
...
Paws::MediaLive::DeleteSchedule - Arguments for method DeleteSchedule on L<Paws::MediaLive>
...
=head1 SYNOPSIS
    ...
    my $DeleteScheduleResponse = $medialive->DeleteSchedule(
      ChannelId => 'My__string',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/medialive/DeleteSchedule>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSchedule in L<Paws::MediaLive>
