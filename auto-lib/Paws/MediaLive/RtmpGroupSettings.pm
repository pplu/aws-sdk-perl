...
As an example, if Att1 is expected to be a Paws::MediaLive::RtmpGroupSettings object:
  ...
  $service_obj->Method(Att1 => { AdMarkers => $value, ..., RestartDelay => $value  });
...
Choose the ad marker type for this output group. MediaLive will create
a message based on the content of each SCTE-35 message, format it for
