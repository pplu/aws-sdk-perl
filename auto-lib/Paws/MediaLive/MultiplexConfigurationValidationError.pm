...
Paws::MediaLive::MultiplexConfigurationValidationError
...
As an example, if Att1 is expected to be a Paws::MediaLive::MultiplexConfigurationValidationError object:

  $service_obj->Method(Att1 => { Message => $value, ..., ValidationErrors => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::MultiplexConfigurationValidationError object:
