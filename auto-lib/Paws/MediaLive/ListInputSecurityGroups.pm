...
=head1 SYNOPSIS
    ...
    my $ListInputSecurityGroupsResponse = $medialive->ListInputSecurityGroups(
      MaxResults => 1,               # OPTIONAL
      NextToken  => 'My__string',    # OPTIONAL
    );

    # Results:
    my $InputSecurityGroups =
      $ListInputSecurityGroupsResponse->InputSecurityGroups;
    my $NextToken = $ListInputSecurityGroupsResponse->NextToken;

    # Returns a L<Paws::MediaLive::ListInputSecurityGroupsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/medialive/ListInputSecurityGroups>
