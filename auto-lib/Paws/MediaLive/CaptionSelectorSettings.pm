...
package Paws::MediaLive::CaptionSelectorSettings;
  use Moose;
  has AncillarySourceSettings => (is => 'ro', isa => 'Paws::MediaLive::AncillarySourceSettings', request_name => 'ancillarySourceSettings', traits => ['NameInRequest']);
...
=head2 AncillarySourceSettings => L<Paws::MediaLive::AncillarySourceSettings>
