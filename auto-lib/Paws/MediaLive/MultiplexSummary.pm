package Paws::MediaLive::MultiplexSummary;
  use Moose;
  ...
  has MultiplexSettings => (is => 'ro', isa => 'Paws::MediaLive::MultiplexSettingsSummary', request_name => 'multiplexSettings', traits => ['NameInRequest']);
...
=head2 MultiplexSettings => L<Paws::MediaLive::MultiplexSettingsSummary>
