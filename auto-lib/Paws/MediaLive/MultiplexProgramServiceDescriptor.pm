package Paws::MediaLive::MultiplexProgramServiceDescriptor;
  use Moose;
...
Paws::MediaLive::MultiplexProgramServiceDescriptor
...
As an example, if Att1 is expected to be a Paws::MediaLive::MultiplexProgramServiceDescriptor object:

  $service_obj->Method(Att1 => { ProviderName => $value, ..., ServiceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::MultiplexProgramServiceDescriptor object:
