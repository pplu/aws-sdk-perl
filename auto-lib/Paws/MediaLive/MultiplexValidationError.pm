package Paws::MediaLive::MultiplexValidationError;
  use Moose;
...
Paws::MediaLive::MultiplexValidationError
...
As an example, if Att1 is expected to be a Paws::MediaLive::MultiplexValidationError object:

  $service_obj->Method(Att1 => { ElementPath => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::MultiplexValidationError object:
