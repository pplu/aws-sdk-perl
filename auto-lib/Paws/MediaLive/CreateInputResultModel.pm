...
Paws::MediaLive::CreateInputResultModel
...
As an example, if Att1 is expected to be a Paws::MediaLive::CreateInputResultModel object:

  $service_obj->Method(Att1 => { Input => $value, ..., Input => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::CreateInputResultModel object:
