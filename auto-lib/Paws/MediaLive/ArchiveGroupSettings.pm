...
package Paws::MediaLive::ArchiveGroupSettings;
  use Moose;
  has ArchiveCdnSettings => (is => 'ro', isa => 'Paws::MediaLive::ArchiveCdnSettings', request_name => 'archiveCdnSettings', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::MediaLive::ArchiveGroupSettings object:
  ...
  $service_obj->Method(Att1 => { ArchiveCdnSettings => $value, ..., RolloverInterval => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::MediaLive::ArchiveGroupSettings object:
  ...
  $result->Att1->ArchiveCdnSettings
...
=head2 ArchiveCdnSettings => L<Paws::MediaLive::ArchiveCdnSettings>
