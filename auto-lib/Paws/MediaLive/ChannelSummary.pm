...
package Paws::MediaLive::ChannelSummary;
  ...
  use Paws::MediaLive::Types qw/MediaLive_ChannelEgressEndpoint MediaLive_OutputDestination MediaLive_Tags MediaLive_InputSpecification MediaLive_InputAttachment/;
