...
=head2 BlockPublicAcls => Bool
  ...
  Specifies whether Amazon S3 should block public ACLs for this bucket.
...
ACLs on this bucket and any objects that it contains.
...
this bucket. If this element is set to C<TRUE>, then only the bucket
owner and AWS Services can access this bucket if it has a public
policy.
