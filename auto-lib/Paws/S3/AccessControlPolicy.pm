package Paws::S3::AccessControlPolicy;
  use Moose;
  has Grants => (is => 'ro', isa => 'ArrayRef[Paws::S3::Grant]', request_name => 'Grant', xmlname => 'AccessControlList', request_name => 'AccessControlList', traits => ['NameInRequest','Unwrapped','NameInRequest']);
