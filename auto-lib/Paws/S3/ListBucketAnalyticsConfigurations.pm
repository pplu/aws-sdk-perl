...
Paws::S3::ListBucketAnalyticsConfigurations - Arguments for method ListBucketAnalyticsConfigurations on Paws::S3
...
As an example:
  ...
  $service_obj->ListBucketAnalyticsConfigurations(Att1 => $value1, Att2 => $value2, ...);
