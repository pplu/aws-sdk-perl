...
package Paws::S3::SelectObjectContent;
  ...
  use Paws::S3::Types qw/S3_ScanRange S3_RequestProgress S3_OutputSerialization S3_InputSerialization/;
  ...
  has ScanRange => (is => 'ro', isa => S3_ScanRange, predicate => 1);
