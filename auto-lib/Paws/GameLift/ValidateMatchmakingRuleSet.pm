...
Paws::GameLift::ValidateMatchmakingRuleSet - Arguments for method ValidateMatchmakingRuleSet on Paws::GameLift
...
As an example:
  ...
  $service_obj->ValidateMatchmakingRuleSet(Att1 => $value1, Att2 => $value2, ...);
