...
Paws::GameLift::DeleteMatchmakingConfiguration - Arguments for method DeleteMatchmakingConfiguration on Paws::GameLift
...
As an example:
  ...
  $service_obj->DeleteMatchmakingConfiguration(Att1 => $value1, Att2 => $value2, ...);
