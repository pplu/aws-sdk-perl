...
Paws::DataPipeline::PipelineObjectMap
...
As an example, if Att1 is expected to be a Paws::DataPipeline::PipelineObjectMap object:

  $service_obj->Method(Att1 => { key1 => $value, ..., keyN => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataPipeline::PipelineObjectMap object:
