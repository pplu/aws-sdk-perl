...
Paws::MTurk::DisassociateQualificationFromWorker - Arguments for method DisassociateQualificationFromWorker on Paws::MTurk
...
As an example:
  ...
  $service_obj->DisassociateQualificationFromWorker(Att1 => $value1, Att2 => $value2, ...);
