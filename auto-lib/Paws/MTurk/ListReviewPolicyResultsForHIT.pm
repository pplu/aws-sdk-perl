...
package Paws::MTurk::ListReviewPolicyResultsForHIT;
  ...
  has HITId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has MaxResults => (is => 'ro', isa => Int, predicate => 1);
  has NextToken => (is => 'ro', isa => Str, predicate => 1);
  has PolicyLevels => (is => 'ro', isa => ArrayRef[Str|Undef], predicate => 1);
  has RetrieveActions => (is => 'ro', isa => Bool, predicate => 1);
  has RetrieveResults => (is => 'ro', isa => Bool, predicate => 1);
