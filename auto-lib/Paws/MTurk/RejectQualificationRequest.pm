...
Paws::MTurk::RejectQualificationRequest - Arguments for method RejectQualificationRequest on Paws::MTurk
...
As an example:
  ...
  $service_obj->RejectQualificationRequest(Att1 => $value1, Att2 => $value2, ...);
