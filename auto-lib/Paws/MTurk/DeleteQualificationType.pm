...
Paws::MTurk::DeleteQualificationType - Arguments for method DeleteQualificationType on Paws::MTurk
...
As an example:
  ...
  $service_obj->DeleteQualificationType(Att1 => $value1, Att2 => $value2, ...);
