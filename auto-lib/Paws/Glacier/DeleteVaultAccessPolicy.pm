...
Paws::Glacier::DeleteVaultAccessPolicy - Arguments for method DeleteVaultAccessPolicy on Paws::Glacier
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteVaultAccessPolicy.

As an example:

  $service_obj->DeleteVaultAccessPolicy(Att1 => $value1, Att2 => $value2, ...);
