...
package Paws::Glacier::InitiateJob;
  ...
  use Paws::Glacier::Types qw/Glacier_JobParameters/;
  has AccountId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has JobParameters => (is => 'ro', isa => Glacier_JobParameters, predicate => 1);
  ...
  'types' => {
               ...
               'JobParameters' => {
                                    'class' => 'Paws::Glacier::JobParameters',
                                    'type' => 'Glacier_JobParameters'
                                  }
             },
  'ParamInURI' => {
                    'AccountId' => 'accountId',
...
=head2 JobParameters => Glacier_JobParameters
