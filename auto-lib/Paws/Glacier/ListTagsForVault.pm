...
Paws::Glacier::ListTagsForVault - Arguments for method ListTagsForVault on Paws::Glacier
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to ListTagsForVault.

As an example:

  $service_obj->ListTagsForVault(Att1 => $value1, Att2 => $value2, ...);
