...
=head2 Publish(Message => Str, [MessageAttributes => HashRef[L<Paws::SNS::MessageAttributeValue>], MessageStructure => Str, PhoneNumber => Str, Subject => Str, TargetArn => Str, TopicArn => Str])
...
=head2 SetSMSAttributes(Attributes => HashRef[Str])
