...
package Paws::SSMContacts::ValidationExceptionField;
  use Moose;
...
Paws::SSMContacts::ValidationExceptionField
...
As an example, if Att1 is expected to be a Paws::SSMContacts::ValidationExceptionField object:

  $service_obj->Method(Att1 => { Message => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SSMContacts::ValidationExceptionField object:
