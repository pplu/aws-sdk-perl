...
package Paws::ServiceDiscovery::ListOperations;
  ...
  use Paws::ServiceDiscovery::Types qw/ServiceDiscovery_OperationFilter/;
  has Filters => (is => 'ro', isa => ArrayRef[ServiceDiscovery_OperationFilter], predicate => 1);
  ...
  'types' => {
               'Filters' => {
                              'type' => 'ArrayRef[ServiceDiscovery_OperationFilter]',
                              'class' => 'Paws::ServiceDiscovery::OperationFilter'
                            },
               'NextToken' => {
                                'type' => 'Str'
                              },
...
=head2 Filters => ArrayRef[ServiceDiscovery_OperationFilter]
