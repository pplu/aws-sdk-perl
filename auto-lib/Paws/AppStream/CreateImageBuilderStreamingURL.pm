...
Paws::AppStream::CreateImageBuilderStreamingURL - Arguments for method CreateImageBuilderStreamingURL on Paws::AppStream
...
As an example:
  ...
  $service_obj->CreateImageBuilderStreamingURL(Att1 => $value1, Att2 => $value2, ...);
