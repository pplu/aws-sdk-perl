...
=head2 AdminInitiateAuth(AuthFlow => Str, ClientId => Str, UserPoolId => Str, [AuthParameters => HashRef[Str], ClientMetadata => HashRef[Str]])
...
=head2 AdminRespondToAuthChallenge(ChallengeName => Str, ClientId => Str, UserPoolId => Str, [ChallengeResponses => HashRef[Str], Session => Str])
...
=head2 InitiateAuth(AuthFlow => Str, ClientId => Str, [AuthParameters => HashRef[Str], ClientMetadata => HashRef[Str]])
...
=head2 RespondToAuthChallenge(ChallengeName => Str, ClientId => Str, [ChallengeResponses => HashRef[Str], Session => Str])
