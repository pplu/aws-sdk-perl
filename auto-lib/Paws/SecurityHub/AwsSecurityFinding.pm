...
package Paws::SecurityHub::AwsSecurityFinding;
  ...
  use Paws::SecurityHub::Types qw/SecurityHub_Compliance SecurityHub_Resource SecurityHub_ThreatIntelIndicator SecurityHub_FieldMap SecurityHub_Severity SecurityHub_ProcessDetails SecurityHub_Remediation SecurityHub_Malware SecurityHub_Note SecurityHub_Network SecurityHub_RelatedFinding/;
...
security-findings provider created the potential security issue that a
finding captured.
