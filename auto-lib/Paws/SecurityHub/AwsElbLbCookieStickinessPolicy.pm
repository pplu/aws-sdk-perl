...
package Paws::SecurityHub::AwsElbLbCookieStickinessPolicy;
  use Moose;
...
Paws::SecurityHub::AwsElbLbCookieStickinessPolicy
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsElbLbCookieStickinessPolicy object:

  $service_obj->Method(Att1 => { CookieExpirationPeriod => $value, ..., PolicyName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsElbLbCookieStickinessPolicy object:
