...
Paws::SecurityHub::AwsEc2SecurityGroupIpv6Range
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsEc2SecurityGroupIpv6Range object:

  $service_obj->Method(Att1 => { CidrIpv6 => $value, ..., CidrIpv6 => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsEc2SecurityGroupIpv6Range object:
