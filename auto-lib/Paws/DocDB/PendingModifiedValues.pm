...
Paws::DocDB::PendingModifiedValues
...
As an example, if Att1 is expected to be a Paws::DocDB::PendingModifiedValues object:

  $service_obj->Method(Att1 => { AllocatedStorage => $value, ..., StorageType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DocDB::PendingModifiedValues object:
