package Paws::DocDB::PendingMaintenanceAction;
  use Moose;
...
Paws::DocDB::PendingMaintenanceAction
...
As an example, if Att1 is expected to be a Paws::DocDB::PendingMaintenanceAction object:

  $service_obj->Method(Att1 => { Action => $value, ..., OptInStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DocDB::PendingMaintenanceAction object:
