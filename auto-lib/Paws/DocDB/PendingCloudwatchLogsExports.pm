...
Paws::DocDB::PendingCloudwatchLogsExports
...
As an example, if Att1 is expected to be a Paws::DocDB::PendingCloudwatchLogsExports object:

  $service_obj->Method(Att1 => { LogTypesToDisable => $value, ..., LogTypesToEnable => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DocDB::PendingCloudwatchLogsExports object:
