...
Paws::CloudHSM::GetConfig - Arguments for method GetConfig on Paws::CloudHSM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetConfig.

As an example:

  $service_obj->GetConfig(Att1 => $value1, Att2 => $value2, ...);
