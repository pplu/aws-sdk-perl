...
Paws::CloudHSM::DeleteHsm - Arguments for method DeleteHsm on Paws::CloudHSM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteHsm.
...
This class forms part of L<Paws>, and documents parameters for DeleteHsm in Paws::CloudHSM
