...
package Paws::OpsWorksCM::AssociateNode;
  ...
  has EngineAttributes => (is => 'ro', isa => ArrayRef[OpsWorksCM_EngineAttribute], required => 1, predicate => 1);
...
=head2 B<REQUIRED> EngineAttributes => ArrayRef[OpsWorksCM_EngineAttribute]
