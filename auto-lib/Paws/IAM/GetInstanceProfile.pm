...
Paws::IAM::GetInstanceProfile - Arguments for method GetInstanceProfile on Paws::IAM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetInstanceProfile.
