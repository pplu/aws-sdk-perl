...
Paws::IAM::GetRole - Arguments for method GetRole on Paws::IAM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetRole.

As an example:

  $service_obj->GetRole(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for GetRole in Paws::IAM
