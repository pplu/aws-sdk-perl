...
Paws::IAM::DeletePolicy - Arguments for method DeletePolicy on Paws::IAM
...
This class forms part of L<Paws>, and documents parameters for DeletePolicy in Paws::IAM
