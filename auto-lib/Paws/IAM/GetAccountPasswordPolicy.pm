...
Paws::IAM::GetAccountPasswordPolicy - Arguments for method GetAccountPasswordPolicy on Paws::IAM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetAccountPasswordPolicy.

As an example:

  $service_obj->GetAccountPasswordPolicy(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for GetAccountPasswordPolicy in Paws::IAM
