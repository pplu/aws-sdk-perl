...
Paws::IAM::GetAccountSummary - Arguments for method GetAccountSummary on Paws::IAM
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetAccountSummary.

As an example:

  $service_obj->GetAccountSummary(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for GetAccountSummary in Paws::IAM
