...
package Paws::IAM::CreateOpenIDConnectProvider;
  ...
  has ClientIDList => (is => 'ro', isa => ArrayRef[Str|Undef], predicate => 1);
  has ThumbprintList => (is => 'ro', isa => ArrayRef[Str|Undef], required => 1, predicate => 1);
  has Url => (is => 'ro', isa => Str, required => 1, predicate => 1);
