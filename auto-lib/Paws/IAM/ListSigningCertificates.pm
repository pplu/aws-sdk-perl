...
certificate IDs beyond the maximum you specify, the C<IsTruncated>
...
This class forms part of L<Paws>, and documents parameters for ListSigningCertificates in Paws::IAM
