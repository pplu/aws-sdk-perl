...
Paws::IAM::DetachRolePolicy - Arguments for method DetachRolePolicy on Paws::IAM
...
This class forms part of L<Paws>, and documents parameters for DetachRolePolicy in Paws::IAM
