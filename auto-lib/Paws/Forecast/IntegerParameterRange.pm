package Paws::Forecast::IntegerParameterRange;
  use Moose;
...
Paws::Forecast::IntegerParameterRange
...
As an example, if Att1 is expected to be a Paws::Forecast::IntegerParameterRange object:

  $service_obj->Method(Att1 => { MaxValue => $value, ..., ScalingType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Forecast::IntegerParameterRange object:
...
Not supported for C<IntegerParameterRange>.
