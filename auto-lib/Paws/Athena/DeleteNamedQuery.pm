...
package Paws::Athena::DeleteNamedQuery;
  ...
  has NamedQueryId => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/athena/DeleteNamedQuery>
