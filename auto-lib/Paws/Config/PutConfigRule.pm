...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to PutConfigRule.
...
=head2 B<REQUIRED> ConfigRule => Paws::Config::ConfigRule
