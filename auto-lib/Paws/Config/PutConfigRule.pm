...
package Paws::Config::PutConfigRule;
  ...
  use Paws::Config::Types qw/Config_ConfigRule Config_Tag/;
  has ConfigRule => (is => 'ro', isa => Config_ConfigRule, required => 1, predicate => 1);
...
=head2 B<REQUIRED> ConfigRule => Config_ConfigRule
