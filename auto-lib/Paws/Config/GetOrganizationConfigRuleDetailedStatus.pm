...
package Paws::Config::GetOrganizationConfigRuleDetailedStatus;
  ...
  use Paws::Config::Types qw/Config_StatusDetailFilters/;
  has Filters => (is => 'ro', isa => Config_StatusDetailFilters, predicate => 1);
  ...
  'types' => {
               ...
               'Filters' => {
                              'class' => 'Paws::Config::StatusDetailFilters',
                              'type' => 'Config_StatusDetailFilters'
                            }
             },
  'IsRequired' => {
...
=head2 Filters => Config_StatusDetailFilters
