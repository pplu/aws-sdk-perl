...
Paws::Config::DeleteConfigurationRecorder - Arguments for method DeleteConfigurationRecorder on Paws::Config
...
As an example:
  ...
  $service_obj->DeleteConfigurationRecorder(Att1 => $value1, Att2 => $value2, ...);
