package Paws::Config::ConfigurationItem;
  ...
  has SupplementaryConfiguration => (is => 'ro', isa => 'HashRef[Str]', xmlname => 'supplementaryConfiguration', request_name => 'supplementaryConfiguration', traits => ['Unwrapped','NameInRequest']);
...
=head2 SupplementaryConfiguration => HashRef[Str]
