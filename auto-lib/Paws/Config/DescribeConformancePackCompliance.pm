...
package Paws::Config::DescribeConformancePackCompliance;
  ...
  use Paws::Config::Types qw/Config_ConformancePackComplianceFilters/;
  has ConformancePackName => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has Filters => (is => 'ro', isa => Config_ConformancePackComplianceFilters, predicate => 1);
  ...
  'types' => {
               'Filters' => {
                              'class' => 'Paws::Config::ConformancePackComplianceFilters',
                              'type' => 'Config_ConformancePackComplianceFilters'
                            },
               'NextToken' => {
                                'type' => 'Str'
                              },
...
=head2 Filters => Config_ConformancePackComplianceFilters
