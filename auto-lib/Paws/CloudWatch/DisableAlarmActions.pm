...
Paws::CloudWatch::DisableAlarmActions - Arguments for method DisableAlarmActions on Paws::CloudWatch
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DisableAlarmActions.

As an example:

  $service_obj->DisableAlarmActions(Att1 => $value1, Att2 => $value2, ...);
