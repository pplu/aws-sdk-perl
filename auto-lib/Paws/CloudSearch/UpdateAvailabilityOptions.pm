...
package Paws::CloudSearch::UpdateAvailabilityOptions;
  ...
  has MultiAZ => (is => 'ro', isa => Bool, required => 1, predicate => 1);
...
Paws::CloudSearch::UpdateAvailabilityOptions - Arguments for method UpdateAvailabilityOptions on L<Paws::CloudSearch>
...
=head1 SYNOPSIS
    ...
    my $UpdateAvailabilityOptionsResponse =
    ...
    # Returns a L<Paws::CloudSearch::UpdateAvailabilityOptionsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudsearch/UpdateAvailabilityOptions>
