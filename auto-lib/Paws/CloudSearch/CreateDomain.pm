...
Paws::CloudSearch::CreateDomain - Arguments for method CreateDomain on L<Paws::CloudSearch>
...
=head1 SYNOPSIS
    ...
    my $CreateDomainResponse = $cloudsearch->CreateDomain(
    ...
    # Returns a L<Paws::CloudSearch::CreateDomainResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudsearch/CreateDomain>
