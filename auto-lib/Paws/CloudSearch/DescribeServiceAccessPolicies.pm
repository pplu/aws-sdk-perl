...
Paws::CloudSearch::DescribeServiceAccessPolicies - Arguments for method DescribeServiceAccessPolicies on Paws::CloudSearch
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeServiceAccessPolicies.

As an example:

  $service_obj->DescribeServiceAccessPolicies(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeServiceAccessPolicies in Paws::CloudSearch
