...
Paws::CloudSearch::ListDomainNames - Arguments for method ListDomainNames on Paws::CloudSearch
...
As an example:
  ...
  $service_obj->ListDomainNames(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for ListDomainNames in Paws::CloudSearch
