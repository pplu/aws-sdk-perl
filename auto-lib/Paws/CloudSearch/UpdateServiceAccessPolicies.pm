...
package Paws::CloudSearch::UpdateServiceAccessPolicies;
  ...
  has AccessPolicies => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
Paws::CloudSearch::UpdateServiceAccessPolicies - Arguments for method UpdateServiceAccessPolicies on L<Paws::CloudSearch>
...
=head1 SYNOPSIS
    ...
    my $UpdateServiceAccessPoliciesResponse =
      $cloudsearch->UpdateServiceAccessPolicies(
      AccessPolicies => 'MyPolicyDocument',
      DomainName     => 'MyDomainName',

      );

    # Results:
    my $AccessPolicies = $UpdateServiceAccessPoliciesResponse->AccessPolicies;

   # Returns a L<Paws::CloudSearch::UpdateServiceAccessPoliciesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudsearch/UpdateServiceAccessPolicies>
