...
package Paws::CloudSearch::DefineAnalysisScheme;
  ...
  use Paws::CloudSearch::Types qw/CloudSearch_AnalysisScheme/;
  has AnalysisScheme => (is => 'ro', isa => CloudSearch_AnalysisScheme, required => 1, predicate => 1);
...
=head2 B<REQUIRED> AnalysisScheme => CloudSearch_AnalysisScheme
