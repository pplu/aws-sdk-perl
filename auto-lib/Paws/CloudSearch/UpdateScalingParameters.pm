...
package Paws::CloudSearch::UpdateScalingParameters;
  ...
  use Paws::CloudSearch::Types qw/CloudSearch_ScalingParameters/;
  has DomainName => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has ScalingParameters => (is => 'ro', isa => CloudSearch_ScalingParameters, required => 1, predicate => 1);
...
=head2 B<REQUIRED> ScalingParameters => CloudSearch_ScalingParameters
