package Paws::CloudSearch::DateArrayOptions;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::CloudSearch::DateArrayOptions object:

  $service_obj->Method(Att1 => { DefaultValue => $value, ..., SourceFields => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudSearch::DateArrayOptions object:
