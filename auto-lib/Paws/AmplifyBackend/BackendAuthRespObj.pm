...
package Paws::AmplifyBackend::BackendAuthRespObj;
  use Moose;
...
Paws::AmplifyBackend::BackendAuthRespObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::BackendAuthRespObj object:

  $service_obj->Method(Att1 => { AppId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::BackendAuthRespObj object:
