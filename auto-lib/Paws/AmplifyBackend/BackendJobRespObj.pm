...
package Paws::AmplifyBackend::BackendJobRespObj;
  use Moose;
...
Paws::AmplifyBackend::BackendJobRespObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::BackendJobRespObj object:

  $service_obj->Method(Att1 => { AppId => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::BackendJobRespObj object:
