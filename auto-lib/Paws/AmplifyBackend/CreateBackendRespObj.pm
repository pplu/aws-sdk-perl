...
package Paws::AmplifyBackend::CreateBackendRespObj;
  use Moose;
...
Paws::AmplifyBackend::CreateBackendRespObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::CreateBackendRespObj object:

  $service_obj->Method(Att1 => { AppId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::CreateBackendRespObj object:
