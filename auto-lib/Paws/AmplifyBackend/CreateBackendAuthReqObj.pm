...
package Paws::AmplifyBackend::CreateBackendAuthReqObj;
  use Moose;
  has BackendEnvironmentName => (is => 'ro', isa => 'Str', request_name => 'backendEnvironmentName', traits => ['NameInRequest'], required => 1);
  has ResourceConfig => (is => 'ro', isa => 'Paws::AmplifyBackend::CreateBackendAuthResourceConfig', request_name => 'resourceConfig', traits => ['NameInRequest'], required => 1);
...
Paws::AmplifyBackend::CreateBackendAuthReqObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::CreateBackendAuthReqObj object:

  $service_obj->Method(Att1 => { BackendEnvironmentName => $value, ..., ResourceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::CreateBackendAuthReqObj object:
