...
syntax of the C<DescribeJob> action in the C<JobMetadata> data type.
The job logs can be accessed for up to 60 minutes after this request
has been made. To access any of the job logs after 60 minutes have
passed, you'll have to make another call to the C<DescribeJob> action.
