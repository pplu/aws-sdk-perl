...
package Paws::CodeGuruReviewer::RepositoryAnalysis;
  use Moose;
  has RepositoryHead => (is => 'ro', isa => 'Paws::CodeGuruReviewer::RepositoryHeadSourceCodeType', required => 1);
...
As an example, if Att1 is expected to be a Paws::CodeGuruReviewer::RepositoryAnalysis object:
  ...
  $service_obj->Method(Att1 => { RepositoryHead => $value, ..., RepositoryHead => $value  });
...
=head2 B<REQUIRED> RepositoryHead => L<Paws::CodeGuruReviewer::RepositoryHeadSourceCodeType>
