...
Paws::Personalize::IntegerHyperParameterRange
...
As an example, if Att1 is expected to be a Paws::Personalize::IntegerHyperParameterRange object:

  $service_obj->Method(Att1 => { MaxValue => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Personalize::IntegerHyperParameterRange object:
