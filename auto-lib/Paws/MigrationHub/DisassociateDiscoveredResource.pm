...
Paws::MigrationHub::DisassociateDiscoveredResource - Arguments for method DisassociateDiscoveredResource on Paws::MigrationHub
...
As an example:
  ...
  $service_obj->DisassociateDiscoveredResource(Att1 => $value1, Att2 => $value2, ...);
