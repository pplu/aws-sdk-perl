...
Paws::MigrationHub::DescribeMigrationTask - Arguments for method DescribeMigrationTask on Paws::MigrationHub
...
As an example:
  ...
  $service_obj->DescribeMigrationTask(Att1 => $value1, Att2 => $value2, ...);
