...
Paws::MigrationHub::DeleteProgressUpdateStream - Arguments for method DeleteProgressUpdateStream on Paws::MigrationHub
...
As an example:
  ...
  $service_obj->DeleteProgressUpdateStream(Att1 => $value1, Att2 => $value2, ...);
