...
package Paws::ManagedBlockchain::CreateNetwork;
  ...
  use Paws::ManagedBlockchain::Types qw/ManagedBlockchain_VotingPolicy ManagedBlockchain_MemberConfiguration ManagedBlockchain_NetworkFrameworkConfiguration/;
