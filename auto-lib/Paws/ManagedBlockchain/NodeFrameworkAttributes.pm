...
package Paws::ManagedBlockchain::NodeFrameworkAttributes;
  use Moose;
  has Ethereum => (is => 'ro', isa => 'Paws::ManagedBlockchain::NodeEthereumAttributes');
...
As an example, if Att1 is expected to be a Paws::ManagedBlockchain::NodeFrameworkAttributes object:
  ...
  $service_obj->Method(Att1 => { Ethereum => $value, ..., Fabric => $value  });
...
=head2 Ethereum => L<Paws::ManagedBlockchain::NodeEthereumAttributes>
