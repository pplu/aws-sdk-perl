...
Paws::Lightsail::CloseInstancePublicPorts - Arguments for method CloseInstancePublicPorts on Paws::Lightsail
...
As an example:
  ...
  $service_obj->CloseInstancePublicPorts(Att1 => $value1, Att2 => $value2, ...);
