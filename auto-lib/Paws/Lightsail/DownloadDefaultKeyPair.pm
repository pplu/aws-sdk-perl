...
Paws::Lightsail::DownloadDefaultKeyPair - Arguments for method DownloadDefaultKeyPair on Paws::Lightsail
...
As an example:
  ...
  $service_obj->DownloadDefaultKeyPair(Att1 => $value1, Att2 => $value2, ...);
