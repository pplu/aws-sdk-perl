...
Paws::Lightsail::GetInstancePortStates - Arguments for method GetInstancePortStates on Paws::Lightsail
...
As an example:
  ...
  $service_obj->GetInstancePortStates(Att1 => $value1, Att2 => $value2, ...);
