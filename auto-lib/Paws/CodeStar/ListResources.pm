...
Paws::CodeStar::ListResources - Arguments for method ListResources on L<Paws::CodeStar>
...
=head1 SYNOPSIS
    ...
    my $ListResourcesResult = $codestar->ListResources(
    ...
    # Results:
    my $NextToken = $ListResourcesResult->NextToken;
    my $Resources = $ListResourcesResult->Resources;

    # Returns a L<Paws::CodeStar::ListResourcesResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar/ListResources>
