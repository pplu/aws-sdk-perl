...
=head1 SYNOPSIS
    ...
    my $ListTagsForProjectResult = $codestar->ListTagsForProject(
      Id         => 'MyProjectId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar/ListTagsForProject>
