package Paws::DLM::Types;
  ...
  class_type DLM_ListTagsForResourceRequest, { class => 'Paws::DLM::ListTagsForResourceRequest' };
  class_type DLM_ListTagsForResourceResponse, { class => 'Paws::DLM::ListTagsForResourceResponse' };
  ...
  class_type DLM_TagMap, { class => 'Paws::DLM::TagMap' };
  class_type DLM_TagResourceRequest, { class => 'Paws::DLM::TagResourceRequest' };
  class_type DLM_TagResourceResponse, { class => 'Paws::DLM::TagResourceResponse' };
  class_type DLM_UntagResourceRequest, { class => 'Paws::DLM::UntagResourceRequest' };
  class_type DLM_UntagResourceResponse, { class => 'Paws::DLM::UntagResourceResponse' };
