...
Paws::CloudFormation::ListStackSetOperationResults - Arguments for method ListStackSetOperationResults on Paws::CloudFormation
...
As an example:
  ...
  $service_obj->ListStackSetOperationResults(Att1 => $value1, Att2 => $value2, ...);
