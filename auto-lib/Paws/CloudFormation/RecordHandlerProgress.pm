...
package Paws::CloudFormation::RecordHandlerProgress;
  ...
  has BearerToken => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has ClientRequestToken => (is => 'ro', isa => Str, predicate => 1);
  has CurrentOperationStatus => (is => 'ro', isa => Str, predicate => 1);
  has ErrorCode => (is => 'ro', isa => Str, predicate => 1);
  has OperationStatus => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has ResourceModel => (is => 'ro', isa => Str, predicate => 1);
  has StatusMessage => (is => 'ro', isa => Str, predicate => 1);
