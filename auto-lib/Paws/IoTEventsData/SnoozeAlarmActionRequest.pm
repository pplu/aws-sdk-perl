...
package Paws::IoTEventsData::SnoozeAlarmActionRequest;
  use Moose;
  ...
  has SnoozeDuration => (is => 'ro', isa => 'Int', request_name => 'snoozeDuration', traits => ['NameInRequest'], required => 1);
...
Paws::IoTEventsData::SnoozeAlarmActionRequest
...
As an example, if Att1 is expected to be a Paws::IoTEventsData::SnoozeAlarmActionRequest object:

  $service_obj->Method(Att1 => { AlarmModelName => $value, ..., SnoozeDuration => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTEventsData::SnoozeAlarmActionRequest object:
...
=head2 B<REQUIRED> SnoozeDuration => Int

The snooze time in seconds. The alarm automatically changes to the
C<NORMAL> state after this duration.
