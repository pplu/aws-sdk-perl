...
package Paws::IoTEventsData::EnableAlarmActionRequest;
  use Moose;
...
Paws::IoTEventsData::EnableAlarmActionRequest
...
As an example, if Att1 is expected to be a Paws::IoTEventsData::EnableAlarmActionRequest object:

  $service_obj->Method(Att1 => { AlarmModelName => $value, ..., RequestId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTEventsData::EnableAlarmActionRequest object:
