...
package Paws::IoTEventsData::ResetAlarmActionRequest;
  use Moose;
...
Paws::IoTEventsData::ResetAlarmActionRequest
...
As an example, if Att1 is expected to be a Paws::IoTEventsData::ResetAlarmActionRequest object:

  $service_obj->Method(Att1 => { AlarmModelName => $value, ..., RequestId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTEventsData::ResetAlarmActionRequest object:
