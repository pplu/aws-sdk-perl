...
package Paws::ApplicationMigration::OS;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::ApplicationMigration::OS object:

  $service_obj->Method(Att1 => { FullString => $value, ..., FullString => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationMigration::OS object:
