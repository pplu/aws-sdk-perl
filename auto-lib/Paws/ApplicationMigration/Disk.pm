...
package Paws::ApplicationMigration::Disk;
  use Moose;
...
Paws::ApplicationMigration::Disk
...
As an example, if Att1 is expected to be a Paws::ApplicationMigration::Disk object:

  $service_obj->Method(Att1 => { Bytes => $value, ..., DeviceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationMigration::Disk object:
