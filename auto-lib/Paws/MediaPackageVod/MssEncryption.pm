...
package Paws::MediaPackageVod::MssEncryption;
  use Moo;
...
Paws::MediaPackageVod::MssEncryption
...
As an example, if Att1 is expected to be a Paws::MediaPackageVod::MssEncryption object:

  $service_obj->Method(Att1 => { SpekeKeyProvider => $value, ..., SpekeKeyProvider => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageVod::MssEncryption object:
