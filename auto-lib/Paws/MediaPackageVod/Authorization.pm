...
package Paws::MediaPackageVod::Authorization;
  use Moose;
...
Paws::MediaPackageVod::Authorization
...
As an example, if Att1 is expected to be a Paws::MediaPackageVod::Authorization object:

  $service_obj->Method(Att1 => { CdnIdentifierSecret => $value, ..., SecretsRoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageVod::Authorization object:
