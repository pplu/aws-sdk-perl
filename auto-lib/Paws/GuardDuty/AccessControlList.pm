...
package Paws::GuardDuty::AccessControlList;
  use Moose;
...
Paws::GuardDuty::AccessControlList
...
As an example, if Att1 is expected to be a Paws::GuardDuty::AccessControlList object:

  $service_obj->Method(Att1 => { AllowsPublicReadAccess => $value, ..., AllowsPublicWriteAccess => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::AccessControlList object:
