...
package Paws::WAF::ByteMatchSet;
  ...
  has ByteMatchTuples => (is => 'ro', isa => ArrayRef[WAF_ByteMatchTuple], required => 1);
  ...
  'types' => {
               'ByteMatchTuples' => {
                                      'type' => 'ArrayRef[WAF_ByteMatchTuple]',
...
=head2 B<REQUIRED> ByteMatchTuples => ArrayRef[WAF_ByteMatchTuple]
