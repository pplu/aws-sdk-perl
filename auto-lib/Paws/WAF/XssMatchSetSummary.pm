package Paws::WAF::XssMatchSetSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAF::XssMatchSetSummary object:

  $service_obj->Method(Att1 => { Name => $value, ..., XssMatchSetId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAF::XssMatchSetSummary object:
