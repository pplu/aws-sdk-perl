...
package Paws::WAF::UpdateXssMatchSet;
  ...
  use Paws::WAF::Types qw/WAF_XssMatchSetUpdate/;
  has ChangeToken => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has Updates => (is => 'ro', isa => ArrayRef[WAF_XssMatchSetUpdate], required => 1, predicate => 1);
  has XssMatchSetId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  ...
  'types' => {
               'Updates' => {
                              'class' => 'Paws::WAF::XssMatchSetUpdate',
                              'type' => 'ArrayRef[WAF_XssMatchSetUpdate]'
                            },
               'ChangeToken' => {
                                  'type' => 'Str'
                                },
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/waf/UpdateXssMatchSet>
...
=head2 B<REQUIRED> Updates => ArrayRef[WAF_XssMatchSetUpdate]
