...
=head1 SYNOPSIS
    ...
    # sets.
    my $ListSizeConstraintSetsResponse = $waf->ListSizeConstraintSets(
      {
        'Limit' => 100
      }
    );
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/waf/ListSizeConstraintSets>
