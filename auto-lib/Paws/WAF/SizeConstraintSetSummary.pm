package Paws::WAF::SizeConstraintSetSummary;
  use Moose;
...
Paws::WAF::SizeConstraintSetSummary
...
As an example, if Att1 is expected to be a Paws::WAF::SizeConstraintSetSummary object:

  $service_obj->Method(Att1 => { Name => $value, ..., SizeConstraintSetId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAF::SizeConstraintSetSummary object:
