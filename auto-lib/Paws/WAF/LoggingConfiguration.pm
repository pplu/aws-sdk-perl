...
package Paws::WAF::LoggingConfiguration;
  ...
  'types' => {
               ...
               'RedactedFields' => {
                                     ...
                                     'type' => 'ArrayRef[WAF_FieldToMatch]'
                                   }
             },
  'IsRequired' => {
                    'ResourceArn' => 1,
...
As an example, if Att1 is expected to be a Paws::WAF::LoggingConfiguration object:

  $service_obj->Method(Att1 => { LogDestinationConfigs => $value, ..., ResourceArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAF::LoggingConfiguration object:
...
=head2 RedactedFields => ArrayRef[WAF_FieldToMatch]
