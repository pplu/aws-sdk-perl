...
package Paws::WAF::IPSetUpdate;
  ...
  has IPSetDescriptor => (is => 'ro', isa => WAF_IPSetDescriptor, required => 1);
...
As an example, if Att1 is expected to be a Paws::WAF::IPSetUpdate object:

  $service_obj->Method(Att1 => { Action => $value, ..., IPSetDescriptor => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAF::IPSetUpdate object:
...
=head2 B<REQUIRED> IPSetDescriptor => WAF_IPSetDescriptor
