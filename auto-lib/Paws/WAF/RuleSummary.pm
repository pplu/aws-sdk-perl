...
As an example, if Att1 is expected to be a Paws::WAF::RuleSummary object:

  $service_obj->Method(Att1 => { Name => $value, ..., RuleId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAF::RuleSummary object:
