package Paws::KinesisAnalyticsV2::KinesisFirehoseInputUpdate;
  use Moose;
...
Paws::KinesisAnalyticsV2::KinesisFirehoseInputUpdate
...
As an example, if Att1 is expected to be a Paws::KinesisAnalyticsV2::KinesisFirehoseInputUpdate object:

  $service_obj->Method(Att1 => { ResourceARNUpdate => $value, ..., ResourceARNUpdate => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalyticsV2::KinesisFirehoseInputUpdate object:
