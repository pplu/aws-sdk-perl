...
package Paws::KinesisAnalyticsV2::SqlApplicationConfiguration;
  ...
  use Paws::KinesisAnalyticsV2::Types qw/KinesisAnalyticsV2_ReferenceDataSource KinesisAnalyticsV2_Output KinesisAnalyticsV2_Input/;
...
Paws::KinesisAnalyticsV2::SqlApplicationConfiguration
...
As an example, if Att1 is expected to be a Paws::KinesisAnalyticsV2::SqlApplicationConfiguration object:

  $service_obj->Method(Att1 => { Inputs => $value, ..., ReferenceDataSources => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalyticsV2::SqlApplicationConfiguration object:
