...
Paws::KinesisAnalyticsV2::KinesisStreamsInputDescription
...
As an example, if Att1 is expected to be a Paws::KinesisAnalyticsV2::KinesisStreamsInputDescription object:

  $service_obj->Method(Att1 => { ResourceARN => $value, ..., RoleARN => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalyticsV2::KinesisStreamsInputDescription object:
