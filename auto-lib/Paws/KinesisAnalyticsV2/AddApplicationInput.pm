...
package Paws::KinesisAnalyticsV2::AddApplicationInput;
  ...
  use Paws::KinesisAnalyticsV2::Types qw/KinesisAnalyticsV2_Input/;
  ...
  has Input => (is => 'ro', isa => KinesisAnalyticsV2_Input, required => 1, predicate => 1);
...
=head2 B<REQUIRED> Input => KinesisAnalyticsV2_Input
