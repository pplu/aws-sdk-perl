package Paws::Neptune::OptionGroupMembership;
  use Moose;
...
Paws::Neptune::OptionGroupMembership
...
As an example, if Att1 is expected to be a Paws::Neptune::OptionGroupMembership object:

  $service_obj->Method(Att1 => { OptionGroupName => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Neptune::OptionGroupMembership object:
