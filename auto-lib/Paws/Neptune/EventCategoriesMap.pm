package Paws::Neptune::EventCategoriesMap;
  use Moose;
...
Paws::Neptune::EventCategoriesMap
...
As an example, if Att1 is expected to be a Paws::Neptune::EventCategoriesMap object:

  $service_obj->Method(Att1 => { EventCategories => $value, ..., SourceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Neptune::EventCategoriesMap object:
