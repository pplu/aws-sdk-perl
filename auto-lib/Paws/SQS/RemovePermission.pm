...
Paws::SQS::RemovePermission - Arguments for method RemovePermission on Paws::SQS
...
This class forms part of L<Paws>, and documents parameters for RemovePermission in Paws::SQS
