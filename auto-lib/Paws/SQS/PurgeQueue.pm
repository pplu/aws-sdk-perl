...
Paws::SQS::PurgeQueue - Arguments for method PurgeQueue on Paws::SQS
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to PurgeQueue.
