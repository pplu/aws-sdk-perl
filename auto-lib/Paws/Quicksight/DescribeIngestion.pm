...
package Paws::Quicksight::DescribeIngestion;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribeIngestion');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/accounts/{AwsAccountId}/data-sets/{DataSetId}/ingestions/{IngestionId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Quicksight::DescribeIngestionResponse');
1;
...
Paws::Quicksight::DescribeIngestion - Arguments for method DescribeIngestion on L<Paws::Quicksight>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DescribeIngestion on the
L<Amazon QuickSight|Paws::Quicksight> service. Use the attributes of this class
as arguments to method DescribeIngestion.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/quicksight/DescribeIngestion>
...
This class forms part of L<Paws>, documenting arguments for method DescribeIngestion in L<Paws::Quicksight>
