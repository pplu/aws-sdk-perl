...
package Paws::Quicksight::DescribeDataSource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Quicksight::DescribeDataSourceResponse');
1;
...
Paws::Quicksight::DescribeDataSource - Arguments for method DescribeDataSource on L<Paws::Quicksight>
...
=head1 SYNOPSIS
    ...
    my $DescribeDataSourceResponse = $quicksight->DescribeDataSource(
    ...
    # Results:
    my $DataSource = $DescribeDataSourceResponse->DataSource;
    my $RequestId  = $DescribeDataSourceResponse->RequestId;
    my $Status     = $DescribeDataSourceResponse->Status;

    # Returns a L<Paws::Quicksight::DescribeDataSourceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/quicksight/DescribeDataSource>
...
This class forms part of L<Paws>, documenting arguments for method DescribeDataSource in L<Paws::Quicksight>
