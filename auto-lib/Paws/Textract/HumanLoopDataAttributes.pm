...
Paws::Textract::HumanLoopDataAttributes
...
As an example, if Att1 is expected to be a Paws::Textract::HumanLoopDataAttributes object:

  $service_obj->Method(Att1 => { ContentClassifiers => $value, ..., ContentClassifiers => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Textract::HumanLoopDataAttributes object:
