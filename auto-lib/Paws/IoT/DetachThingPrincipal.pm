...
package Paws::IoT::DetachThingPrincipal;
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'DetachThingPrincipalResult');
1;
...
Paws::IoT::DetachThingPrincipal - Arguments for method DetachThingPrincipal on Paws::IoT
...
As an example:
  ...
  $service_obj->DetachThingPrincipal(Att1 => $value1, Att2 => $value2, ...);
