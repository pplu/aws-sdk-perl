...
package Paws::IoT::GetLoggingOptions;
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'GetLoggingOptionsResult');
1;
...
Paws::IoT::GetLoggingOptions - Arguments for method GetLoggingOptions on Paws::IoT
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetLoggingOptions.

As an example:

  $service_obj->GetLoggingOptions(Att1 => $value1, Att2 => $value2, ...);
