package Paws::IoT::HttpUrlDestinationSummary;
  use Moose;
...
Paws::IoT::HttpUrlDestinationSummary
...
As an example, if Att1 is expected to be a Paws::IoT::HttpUrlDestinationSummary object:

  $service_obj->Method(Att1 => { ConfirmationUrl => $value, ..., ConfirmationUrl => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::HttpUrlDestinationSummary object:
