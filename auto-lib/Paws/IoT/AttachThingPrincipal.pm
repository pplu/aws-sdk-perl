...
package Paws::IoT::AttachThingPrincipal;
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'AttachThingPrincipalResult');
1;
...
Paws::IoT::AttachThingPrincipal - Arguments for method AttachThingPrincipal on Paws::IoT
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to AttachThingPrincipal.

As an example:

  $service_obj->AttachThingPrincipal(Att1 => $value1, Att2 => $value2, ...);
