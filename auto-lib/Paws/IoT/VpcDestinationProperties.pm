...
package Paws::IoT::VpcDestinationProperties;
  use Moose;
...
Paws::IoT::VpcDestinationProperties
...
As an example, if Att1 is expected to be a Paws::IoT::VpcDestinationProperties object:

  $service_obj->Method(Att1 => { RoleArn => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::VpcDestinationProperties object:
