...
package Paws::IoT::AwsJobTimeoutConfig;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoT::AwsJobTimeoutConfig object:

  $service_obj->Method(Att1 => { InProgressTimeoutInMinutes => $value, ..., InProgressTimeoutInMinutes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::AwsJobTimeoutConfig object:
