...
package Paws::LexRuntimeV2::ActiveContext;
  use Moose;
  has ContextAttributes => (is => 'ro', isa => 'Paws::LexRuntimeV2::ActiveContextParametersMap', request_name => 'contextAttributes', traits => ['NameInRequest']);
...
=head2 ContextAttributes => L<Paws::LexRuntimeV2::ActiveContextParametersMap>
