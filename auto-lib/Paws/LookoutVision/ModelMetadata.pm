...
package Paws::LookoutVision::ModelMetadata;
  use Moose;
...
Paws::LookoutVision::ModelMetadata
...
As an example, if Att1 is expected to be a Paws::LookoutVision::ModelMetadata object:

  $service_obj->Method(Att1 => { CreationTimestamp => $value, ..., StatusMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LookoutVision::ModelMetadata object:
