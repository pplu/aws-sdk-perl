...
=item ActionParams => IoT_MitigationActionParams
...
=item DestinationConfiguration => IoT_TopicRuleDestinationConfiguration
...
=item AuditCheckToActionsMapping => IoT_AuditCheckToActionsMapping

=item ClientRequestToken => Str

=item Target => IoT_AuditMitigationActionsTaskTarget
