...
Paws::ElasticBeanstalk::RequestEnvironmentInfo - Arguments for method RequestEnvironmentInfo on Paws::ElasticBeanstalk
...
As an example:
  ...
  $service_obj->RequestEnvironmentInfo(Att1 => $value1, Att2 => $value2, ...);
