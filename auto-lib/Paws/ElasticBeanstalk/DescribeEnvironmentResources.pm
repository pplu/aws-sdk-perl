...
Paws::ElasticBeanstalk::DescribeEnvironmentResources - Arguments for method DescribeEnvironmentResources on Paws::ElasticBeanstalk
...
As an example:
  ...
  $service_obj->DescribeEnvironmentResources(Att1 => $value1, Att2 => $value2, ...);
