...
package Paws::ElasticBeanstalk::ListPlatformVersions;
  ...
  use Paws::ElasticBeanstalk::Types qw/ElasticBeanstalk_PlatformFilter/;
  has Filters => (is => 'ro', isa => ArrayRef[ElasticBeanstalk_PlatformFilter], predicate => 1);
  ...
  'types' => {
               ...
               'Filters' => {
                              'type' => 'ArrayRef[ElasticBeanstalk_PlatformFilter]',
                              'class' => 'Paws::ElasticBeanstalk::PlatformFilter'
                            }
             }
}
;
...
=head2 Filters => ArrayRef[ElasticBeanstalk_PlatformFilter]
