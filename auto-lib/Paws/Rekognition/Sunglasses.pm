package Paws::Rekognition::Sunglasses;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Rekognition::Sunglasses object:

  $service_obj->Method(Att1 => { Confidence => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Rekognition::Sunglasses object:
