...
=head1 SYNOPSIS
    ...
    my $BillableDurationSeconds =
      $GetContentModerationResponse->BillableDurationSeconds;
    my $ErrorCode        = $GetContentModerationResponse->ErrorCode;
    ...
    my $Warnings         = $GetContentModerationResponse->Warnings;
