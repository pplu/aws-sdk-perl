...
package Paws::LexModelsV2::SlotDefaultValue;
  use Moose;
...
Paws::LexModelsV2::SlotDefaultValue
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::SlotDefaultValue object:

  $service_obj->Method(Att1 => { DefaultValue => $value, ..., DefaultValue => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::SlotDefaultValue object:
