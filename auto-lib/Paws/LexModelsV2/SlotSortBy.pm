...
package Paws::LexModelsV2::SlotSortBy;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::SlotSortBy object:

  $service_obj->Method(Att1 => { Attribute => $value, ..., Order => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::SlotSortBy object:
