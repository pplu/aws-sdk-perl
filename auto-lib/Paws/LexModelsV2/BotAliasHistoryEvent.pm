...
package Paws::LexModelsV2::BotAliasHistoryEvent;
  use Moose;
...
Paws::LexModelsV2::BotAliasHistoryEvent
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::BotAliasHistoryEvent object:

  $service_obj->Method(Att1 => { BotVersion => $value, ..., StartDate => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::BotAliasHistoryEvent object:
