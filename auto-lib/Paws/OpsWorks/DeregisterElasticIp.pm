...
Paws::OpsWorks::DeregisterElasticIp - Arguments for method DeregisterElasticIp on Paws::OpsWorks
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeregisterElasticIp.

As an example:

  $service_obj->DeregisterElasticIp(Att1 => $value1, Att2 => $value2, ...);
