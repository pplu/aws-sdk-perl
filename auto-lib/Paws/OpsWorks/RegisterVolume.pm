...
Paws::OpsWorks::RegisterVolume - Arguments for method RegisterVolume on Paws::OpsWorks
...
As an example:
  ...
  $service_obj->RegisterVolume(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for RegisterVolume in Paws::OpsWorks
