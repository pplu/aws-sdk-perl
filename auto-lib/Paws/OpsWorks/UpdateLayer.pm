...
package Paws::OpsWorks::UpdateLayer;
  ...
  use Paws::OpsWorks::Types qw/OpsWorks_Recipes OpsWorks_VolumeConfiguration OpsWorks_LayerAttributes OpsWorks_CloudWatchLogsConfiguration OpsWorks_LifecycleEventConfiguration/;
