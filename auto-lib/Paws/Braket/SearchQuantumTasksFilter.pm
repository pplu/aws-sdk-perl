...
package Paws::Braket::SearchQuantumTasksFilter;
  use Moose;
...
Paws::Braket::SearchQuantumTasksFilter
...
As an example, if Att1 is expected to be a Paws::Braket::SearchQuantumTasksFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Braket::SearchQuantumTasksFilter object:
