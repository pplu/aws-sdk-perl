...
Paws::CognitoIdentity::DescribeIdentity - Arguments for method DescribeIdentity on Paws::CognitoIdentity
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeIdentity.

As an example:

  $service_obj->DescribeIdentity(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeIdentity in Paws::CognitoIdentity
