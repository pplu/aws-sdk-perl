...
package Paws::CognitoIdentity::DeleteIdentities;
  use Moose;
  has IdentityIdsToDelete => (is => 'ro', isa => 'ArrayRef[Str]', required => 1);
...
Paws::CognitoIdentity::DeleteIdentities - Arguments for method DeleteIdentities on Paws::CognitoIdentity
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteIdentities.

As an example:

  $service_obj->DeleteIdentities(Att1 => $value1, Att2 => $value2, ...);
