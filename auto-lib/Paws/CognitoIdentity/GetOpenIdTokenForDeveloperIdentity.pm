...
package Paws::CognitoIdentity::GetOpenIdTokenForDeveloperIdentity;
  ...
  has IdentityId => (is => 'ro', isa => Str, predicate => 1);
  has IdentityPoolId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has Logins => (is => 'ro', isa => CognitoIdentity_LoginsMap, required => 1, predicate => 1);
  has TokenDuration => (is => 'ro', isa => Int, predicate => 1);
...
=head2 B<REQUIRED> Logins => CognitoIdentity_LoginsMap
