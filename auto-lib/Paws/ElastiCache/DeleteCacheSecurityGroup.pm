...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteCacheSecurityGroup.

As an example:

  $service_obj->DeleteCacheSecurityGroup(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteCacheSecurityGroup in Paws::ElastiCache
