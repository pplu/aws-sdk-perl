...
package Paws::IoTThingsGraph::SystemInstanceFilter;
  use Moo;
...
Paws::IoTThingsGraph::SystemInstanceFilter
...
As an example, if Att1 is expected to be a Paws::IoTThingsGraph::SystemInstanceFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTThingsGraph::SystemInstanceFilter object:
...
includes a GREENGRASS_GROUP_NAME and a STATUS filter searches for
