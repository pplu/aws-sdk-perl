...
package Paws::Inspector::DescribeAssessmentRuns;
  use Moose;
  has AssessmentRunArns => (is => 'ro', isa => 'ArrayRef[Str]', traits => ['NameInRequest'], request_name => 'assessmentRunArns' , required => 1);
...
Paws::Inspector::DescribeAssessmentRuns - Arguments for method DescribeAssessmentRuns on Paws::Inspector
...
As an example:
  ...
  $service_obj->DescribeAssessmentRuns(Att1 => $value1, Att2 => $value2, ...);
