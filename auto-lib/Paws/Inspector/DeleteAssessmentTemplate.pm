...
Paws::Inspector::DeleteAssessmentTemplate - Arguments for method DeleteAssessmentTemplate on Paws::Inspector
...
As an example:
  ...
  $service_obj->DeleteAssessmentTemplate(Att1 => $value1, Att2 => $value2, ...);
