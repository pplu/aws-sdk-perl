...
package Paws::Inspector::DescribeResourceGroups;
  use Moose;
  has ResourceGroupArns => (is => 'ro', isa => 'ArrayRef[Str]', traits => ['NameInRequest'], request_name => 'resourceGroupArns' , required => 1);
...
Paws::Inspector::DescribeResourceGroups - Arguments for method DescribeResourceGroups on Paws::Inspector
...
As an example:
  ...
  $service_obj->DescribeResourceGroups(Att1 => $value1, Att2 => $value2, ...);
