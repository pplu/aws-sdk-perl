...
package Paws::Inspector::DeleteApplication;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Inspector::DeleteApplicationResponse');
...
Paws::Inspector::DeleteApplication - Arguments for method DeleteApplication on Paws::Inspector
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::Inspector>
