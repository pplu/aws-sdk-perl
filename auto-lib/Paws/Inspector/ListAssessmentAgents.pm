...
package Paws::Inspector::ListAssessmentAgents;
  ...
  has filter => (is => 'ro', isa => 'Paws::Inspector::AgentsFilter');
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to ListAssessmentAgents.
