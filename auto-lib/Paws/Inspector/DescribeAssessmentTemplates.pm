...
Paws::Inspector::DescribeAssessmentTemplates - Arguments for method DescribeAssessmentTemplates on Paws::Inspector
...
As an example:
  ...
  $service_obj->DescribeAssessmentTemplates(Att1 => $value1, Att2 => $value2, ...);
