package Paws::Inspector::AgentFilter;
  use Moose;
  has AgentHealthCodes => (is => 'ro', isa => 'ArrayRef[Str]', xmlname => 'agentHealthCodes', request_name => 'agentHealthCodes', traits => ['Unwrapped','NameInRequest'], required => 1);
  has AgentHealths => (is => 'ro', isa => 'ArrayRef[Str]', xmlname => 'agentHealths', request_name => 'agentHealths', traits => ['Unwrapped','NameInRequest'], required => 1);
1;
...
=head2 B<REQUIRED> AgentHealthCodes => ArrayRef[Str]
...
=head2 B<REQUIRED> AgentHealths => ArrayRef[Str]
