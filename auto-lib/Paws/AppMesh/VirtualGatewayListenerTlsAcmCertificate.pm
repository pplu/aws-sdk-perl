...
package Paws::AppMesh::VirtualGatewayListenerTlsAcmCertificate;
  use Moose;
...
Paws::AppMesh::VirtualGatewayListenerTlsAcmCertificate
...
As an example, if Att1 is expected to be a Paws::AppMesh::VirtualGatewayListenerTlsAcmCertificate object:

  $service_obj->Method(Att1 => { CertificateArn => $value, ..., CertificateArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppMesh::VirtualGatewayListenerTlsAcmCertificate object:
