...
package Paws::AppMesh::VirtualGatewayListenerTlsValidationContext;
  use Moose;
  ...
  has Trust => (is => 'ro', isa => 'Paws::AppMesh::VirtualGatewayListenerTlsValidationContextTrust', request_name => 'trust', traits => ['NameInRequest'], required => 1);
...
Paws::AppMesh::VirtualGatewayListenerTlsValidationContext
...
As an example, if Att1 is expected to be a Paws::AppMesh::VirtualGatewayListenerTlsValidationContext object:

  $service_obj->Method(Att1 => { SubjectAlternativeNames => $value, ..., Trust => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppMesh::VirtualGatewayListenerTlsValidationContext object:
...
=head2 B<REQUIRED> Trust => L<Paws::AppMesh::VirtualGatewayListenerTlsValidationContextTrust>
