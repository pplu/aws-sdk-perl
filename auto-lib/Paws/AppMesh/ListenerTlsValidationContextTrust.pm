...
package Paws::AppMesh::ListenerTlsValidationContextTrust;
  use Moose;
...
Paws::AppMesh::ListenerTlsValidationContextTrust
...
As an example, if Att1 is expected to be a Paws::AppMesh::ListenerTlsValidationContextTrust object:

  $service_obj->Method(Att1 => { File => $value, ..., Sds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppMesh::ListenerTlsValidationContextTrust object:
