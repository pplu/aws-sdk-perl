...
Paws::DeviceFarm::GetProject - Arguments for method GetProject on Paws::DeviceFarm
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to GetProject.

As an example:

  $service_obj->GetProject(Att1 => $value1, Att2 => $value2, ...);
