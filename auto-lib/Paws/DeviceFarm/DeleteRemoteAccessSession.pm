...
Paws::DeviceFarm::DeleteRemoteAccessSession - Arguments for method DeleteRemoteAccessSession on Paws::DeviceFarm
...
As an example:
  ...
  $service_obj->DeleteRemoteAccessSession(Att1 => $value1, Att2 => $value2, ...);
