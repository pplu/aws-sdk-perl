...
package Paws::AccessAnalyzer::PolicyGenerationDetails;
  use Moose;
...
Paws::AccessAnalyzer::PolicyGenerationDetails
...
As an example, if Att1 is expected to be a Paws::AccessAnalyzer::PolicyGenerationDetails object:

  $service_obj->Method(Att1 => { PrincipalArn => $value, ..., PrincipalArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AccessAnalyzer::PolicyGenerationDetails object:
