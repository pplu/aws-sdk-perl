...
package Paws::AccessAnalyzer::JobError;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::AccessAnalyzer::JobError object:

  $service_obj->Method(Att1 => { Code => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AccessAnalyzer::JobError object:
