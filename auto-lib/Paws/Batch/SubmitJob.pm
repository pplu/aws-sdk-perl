...
package Paws::Batch::SubmitJob;
  ...
  use Paws::Batch::Types qw/Batch_RetryStrategy Batch_JobTimeout Batch_JobDependency Batch_ParametersMap Batch_ArrayProperties Batch_NodeOverrides Batch_ContainerOverrides/;
