...
Paws::CloudWatchEvents::DescribeEventBus - Arguments for method DescribeEventBus on Paws::CloudWatchEvents
...
As an example:
  ...
  $service_obj->DescribeEventBus(Att1 => $value1, Att2 => $value2, ...);
