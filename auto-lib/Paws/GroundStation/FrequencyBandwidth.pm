...
Paws::GroundStation::FrequencyBandwidth
...
As an example, if Att1 is expected to be a Paws::GroundStation::FrequencyBandwidth object:

  $service_obj->Method(Att1 => { Units => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GroundStation::FrequencyBandwidth object:
