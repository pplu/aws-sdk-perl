...
package Paws::PinpointEmail::ListDomainDeliverabilityCampaignsResponse;
  use Moose;
  has DomainDeliverabilityCampaigns => (is => 'ro', isa => 'ArrayRef[Paws::PinpointEmail::DomainDeliverabilityCampaign]', required => 1);
...
=head2 B<REQUIRED> DomainDeliverabilityCampaigns => ArrayRef[L<Paws::PinpointEmail::DomainDeliverabilityCampaign>]
