...
Paws::Organizations::DeleteOrganization - Arguments for method DeleteOrganization on Paws::Organizations
...
As an example:
  ...
  $service_obj->DeleteOrganization(Att1 => $value1, Att2 => $value2, ...);
