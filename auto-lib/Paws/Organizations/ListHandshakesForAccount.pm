...
C<APPROVE_ALL_FEATURES>. Alternatively, you can specify the
C<ENABLE_ALL_FEATURES> handshake, which generates a separate child
handshake for each member account. When you do specify
C<ParentHandshakeId> to see only the handshakes that were generated by
that parent request.
