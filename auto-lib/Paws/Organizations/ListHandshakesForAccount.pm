...
package Paws::Organizations::ListHandshakesForAccount;
  ...
  use Paws::Organizations::Types qw/Organizations_HandshakeFilter/;
  has Filter => (is => 'ro', isa => Organizations_HandshakeFilter, predicate => 1);
  ...
  'types' => {
               'Filter' => {
                             'class' => 'Paws::Organizations::HandshakeFilter',
                             'type' => 'Organizations_HandshakeFilter'
                           },
               'NextToken' => {
                                'type' => 'Str'
                              },
...
=head2 Filter => Organizations_HandshakeFilter
