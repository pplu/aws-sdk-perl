...
Paws::Organizations::LeaveOrganization - Arguments for method LeaveOrganization on Paws::Organizations
...
As an example:
  ...
  $service_obj->LeaveOrganization(Att1 => $value1, Att2 => $value2, ...);
