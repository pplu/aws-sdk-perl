...
package Paws::WorkSpaces::RebuildWorkspaces;
  ...
  use Paws::WorkSpaces::Types qw/WorkSpaces_RebuildRequest/;
  has RebuildWorkspaceRequests => (is => 'ro', isa => ArrayRef[WorkSpaces_RebuildRequest], required => 1, predicate => 1);
  ...
  'types' => {
               'RebuildWorkspaceRequests' => {
                                               'class' => 'Paws::WorkSpaces::RebuildRequest',
                                               'type' => 'ArrayRef[WorkSpaces_RebuildRequest]'
                                             }
             }
}
;
...
=head2 B<REQUIRED> RebuildWorkspaceRequests => ArrayRef[WorkSpaces_RebuildRequest]
