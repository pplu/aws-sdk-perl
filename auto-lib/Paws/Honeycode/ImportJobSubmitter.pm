...
package Paws::Honeycode::ImportJobSubmitter;
  use Moose;
...
Paws::Honeycode::ImportJobSubmitter
...
As an example, if Att1 is expected to be a Paws::Honeycode::ImportJobSubmitter object:

  $service_obj->Method(Att1 => { Email => $value, ..., UserArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Honeycode::ImportJobSubmitter object:
