...
package Paws::NimbleStudio::CreateStudioComponentInput;
  use Moose;
...
Paws::NimbleStudio::CreateStudioComponentInput
...
As an example, if Att1 is expected to be a Paws::NimbleStudio::CreateStudioComponentInput object:

  $service_obj->Method(Att1 => { Configuration => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NimbleStudio::CreateStudioComponentInput object:
