...
package Paws::NimbleStudio::GetStreamingImageOutput;
  use Moose;
...
Paws::NimbleStudio::GetStreamingImageOutput
...
As an example, if Att1 is expected to be a Paws::NimbleStudio::GetStreamingImageOutput object:

  $service_obj->Method(Att1 => { StreamingImage => $value, ..., StreamingImage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NimbleStudio::GetStreamingImageOutput object:
