...
package Paws::NimbleStudio::LicenseServiceConfiguration;
  use Moose;
...
Paws::NimbleStudio::LicenseServiceConfiguration
...
As an example, if Att1 is expected to be a Paws::NimbleStudio::LicenseServiceConfiguration object:

  $service_obj->Method(Att1 => { Endpoint => $value, ..., Endpoint => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NimbleStudio::LicenseServiceConfiguration object:
