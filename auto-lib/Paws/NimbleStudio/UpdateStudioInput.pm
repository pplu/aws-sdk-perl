...
package Paws::NimbleStudio::UpdateStudioInput;
  use Moose;
...
Paws::NimbleStudio::UpdateStudioInput
...
As an example, if Att1 is expected to be a Paws::NimbleStudio::UpdateStudioInput object:

  $service_obj->Method(Att1 => { AdminRoleArn => $value, ..., UserRoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NimbleStudio::UpdateStudioInput object:
