...
package Paws::NimbleStudio::DeleteStreamingImageOutput;
  use Moose;
...
Paws::NimbleStudio::DeleteStreamingImageOutput
...
As an example, if Att1 is expected to be a Paws::NimbleStudio::DeleteStreamingImageOutput object:

  $service_obj->Method(Att1 => { StreamingImage => $value, ..., StreamingImage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NimbleStudio::DeleteStreamingImageOutput object:
