...
package Paws::NimbleStudio::DeleteLaunchProfileMember;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteLaunchProfileMember');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::NimbleStudio::DeleteLaunchProfileMemberResponse');
1;
...
Paws::NimbleStudio::DeleteLaunchProfileMember - Arguments for method DeleteLaunchProfileMember on L<Paws::NimbleStudio>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteLaunchProfileMember on the
L<AmazonNimbleStudio|Paws::NimbleStudio> service. Use the attributes of this class
as arguments to method DeleteLaunchProfileMember.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/nimble/DeleteLaunchProfileMember>
...
This class forms part of L<Paws>, documenting arguments for method DeleteLaunchProfileMember in L<Paws::NimbleStudio>
