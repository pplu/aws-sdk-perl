...
Paws::CloudWatchLogs::DeleteDestination - Arguments for method DeleteDestination on Paws::CloudWatchLogs
...
As an example:
  ...
  $service_obj->DeleteDestination(Att1 => $value1, Att2 => $value2, ...);
