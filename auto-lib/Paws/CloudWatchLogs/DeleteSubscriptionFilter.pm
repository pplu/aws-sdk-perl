...
Paws::CloudWatchLogs::DeleteSubscriptionFilter - Arguments for method DeleteSubscriptionFilter on Paws::CloudWatchLogs
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteSubscriptionFilter.

As an example:

  $service_obj->DeleteSubscriptionFilter(Att1 => $value1, Att2 => $value2, ...);
