...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeStorediSCSIVolumes.

As an example:

  $service_obj->DescribeStorediSCSIVolumes(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeStorediSCSIVolumes in Paws::StorageGateway
