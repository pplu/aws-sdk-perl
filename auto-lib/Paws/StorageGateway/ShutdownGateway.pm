...
Paws::StorageGateway::ShutdownGateway - Arguments for method ShutdownGateway on Paws::StorageGateway
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to ShutdownGateway.

As an example:

  $service_obj->ShutdownGateway(Att1 => $value1, Att2 => $value2, ...);
