...
package Paws::StorageGateway::UpdateMaintenanceStartTime;
  ...
  has DayOfMonth => (is => 'ro', isa => Int, predicate => 1);
  has DayOfWeek => (is => 'ro', isa => Int, predicate => 1);
  has GatewayARN => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has HourOfDay => (is => 'ro', isa => Int, required => 1, predicate => 1);
  has MinuteOfHour => (is => 'ro', isa => Int, required => 1, predicate => 1);
