...
Paws::StorageGateway::DeleteGateway - Arguments for method DeleteGateway on Paws::StorageGateway
...
This class forms part of L<Paws>, and documents parameters for DeleteGateway in Paws::StorageGateway
