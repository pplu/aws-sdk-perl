...
package Paws::StorageGateway::DescribeCachediSCSIVolumes;
  ...
  has VolumeARNs => (is => 'ro', isa => ArrayRef[Str|Undef], required => 1, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/storagegateway/DescribeCachediSCSIVolumes>
