...
Paws::StorageGateway::DescribeChapCredentials - Arguments for method DescribeChapCredentials on Paws::StorageGateway
...
As an example:
  ...
  $service_obj->DescribeChapCredentials(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DescribeChapCredentials in Paws::StorageGateway
