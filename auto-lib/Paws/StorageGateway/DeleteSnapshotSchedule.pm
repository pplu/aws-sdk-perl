...
Paws::StorageGateway::DeleteSnapshotSchedule - Arguments for method DeleteSnapshotSchedule on Paws::StorageGateway
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteSnapshotSchedule.

As an example:

  $service_obj->DeleteSnapshotSchedule(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DeleteSnapshotSchedule in Paws::StorageGateway
