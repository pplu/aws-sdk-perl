...
Paws::StorageGateway::DisableGateway - Arguments for method DisableGateway on Paws::StorageGateway
...
As an example:
  ...
  $service_obj->DisableGateway(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for DisableGateway in Paws::StorageGateway
