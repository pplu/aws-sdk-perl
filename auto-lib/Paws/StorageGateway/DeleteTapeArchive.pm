...
Paws::StorageGateway::DeleteTapeArchive - Arguments for method DeleteTapeArchive on Paws::StorageGateway
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteTapeArchive.

As an example:

  $service_obj->DeleteTapeArchive(Att1 => $value1, Att2 => $value2, ...);
