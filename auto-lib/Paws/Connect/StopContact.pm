...
As an example:
  ...
  $service_obj->StopContact(Att1 => $value1, Att2 => $value2, ...);
...
The unique identifier of the contact to end. This is the C<ContactId>
value returned from the C<StartOutboundVoiceContact> operation.
