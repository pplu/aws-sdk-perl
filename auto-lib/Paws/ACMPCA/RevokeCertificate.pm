...
As an example:
  ...
  $service_obj->RevokeCertificate(Att1 => $value1, Att2 => $value2, ...);
...
you want and the ARN of your private CA. The B<GetCertificate> function
...
function in the I<AWS Certificate Manager API Reference>.
