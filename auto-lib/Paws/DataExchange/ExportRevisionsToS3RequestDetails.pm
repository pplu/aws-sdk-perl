...
package Paws::DataExchange::ExportRevisionsToS3RequestDetails;
  use Moose;
...
Paws::DataExchange::ExportRevisionsToS3RequestDetails
...
As an example, if Att1 is expected to be a Paws::DataExchange::ExportRevisionsToS3RequestDetails object:

  $service_obj->Method(Att1 => { DataSetId => $value, ..., RevisionDestinations => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataExchange::ExportRevisionsToS3RequestDetails object:
