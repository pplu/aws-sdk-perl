...
Paws::MachineLearning::RDSDatabaseCredentials
...
As an example, if Att1 is expected to be a Paws::MachineLearning::RDSDatabaseCredentials object:

  $service_obj->Method(Att1 => { Password => $value, ..., Username => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MachineLearning::RDSDatabaseCredentials object:
