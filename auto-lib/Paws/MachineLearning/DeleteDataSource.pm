...
Paws::MachineLearning::DeleteDataSource - Arguments for method DeleteDataSource on Paws::MachineLearning
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteDataSource.

As an example:

  $service_obj->DeleteDataSource(Att1 => $value1, Att2 => $value2, ...);
