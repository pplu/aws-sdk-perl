...
package Paws::Chime::DeleteChannel;
  use Moose;
...
Paws::Chime::DeleteChannel - Arguments for method DeleteChannel on L<Paws::Chime>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chime/DeleteChannel>
...
This class forms part of L<Paws>, documenting arguments for method DeleteChannel in L<Paws::Chime>
