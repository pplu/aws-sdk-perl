...
package Paws::Chime::GetMeeting;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chime::GetMeetingResponse');
1;
...
Paws::Chime::GetMeeting - Arguments for method GetMeeting on L<Paws::Chime>
...
=head1 SYNOPSIS
    ...
    my $GetMeetingResponse = $chime->GetMeeting(
    ...
    # Returns a L<Paws::Chime::GetMeetingResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chime/GetMeeting>
...
This class forms part of L<Paws>, documenting arguments for method GetMeeting in L<Paws::Chime>
