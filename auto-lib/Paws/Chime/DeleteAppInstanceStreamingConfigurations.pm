...
This class represents the parameters used for calling the method DeleteAppInstanceStreamingConfigurations on the
L<Amazon Chime|Paws::Chime> service. Use the attributes of this class
as arguments to method DeleteAppInstanceStreamingConfigurations.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteAppInstanceStreamingConfigurations.
