...
package Paws::Chime::UpdateSipMediaApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chime::UpdateSipMediaApplicationResponse');
1;
...
Paws::Chime::UpdateSipMediaApplication - Arguments for method UpdateSipMediaApplication on L<Paws::Chime>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chime/UpdateSipMediaApplication>
...
This class forms part of L<Paws>, documenting arguments for method UpdateSipMediaApplication in L<Paws::Chime>
