package Paws::Chime::VoiceConnectorSettings;
  use Moose;
...
Paws::Chime::VoiceConnectorSettings
...
As an example, if Att1 is expected to be a Paws::Chime::VoiceConnectorSettings object:

  $service_obj->Method(Att1 => { CdrBucket => $value, ..., CdrBucket => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Chime::VoiceConnectorSettings object:
