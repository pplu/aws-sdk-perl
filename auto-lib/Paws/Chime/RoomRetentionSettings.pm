...
package Paws::Chime::RoomRetentionSettings;
  use Moose;
...
Paws::Chime::RoomRetentionSettings
...
As an example, if Att1 is expected to be a Paws::Chime::RoomRetentionSettings object:

  $service_obj->Method(Att1 => { RetentionDays => $value, ..., RetentionDays => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Chime::RoomRetentionSettings object:
