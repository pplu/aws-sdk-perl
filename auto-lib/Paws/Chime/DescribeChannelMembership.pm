...
package Paws::Chime::DescribeChannelMembership;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chime::DescribeChannelMembershipResponse');
1;
...
Paws::Chime::DescribeChannelMembership - Arguments for method DescribeChannelMembership on L<Paws::Chime>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chime/DescribeChannelMembership>
...
This class forms part of L<Paws>, documenting arguments for method DescribeChannelMembership in L<Paws::Chime>
