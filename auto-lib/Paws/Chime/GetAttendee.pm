...
package Paws::Chime::GetAttendee;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chime::GetAttendeeResponse');
1;
...
Paws::Chime::GetAttendee - Arguments for method GetAttendee on L<Paws::Chime>
...
=head1 SYNOPSIS
    ...
    my $GetAttendeeResponse = $chime->GetAttendee(
    ...
    # Returns a L<Paws::Chime::GetAttendeeResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chime/GetAttendee>
...
This class forms part of L<Paws>, documenting arguments for method GetAttendee in L<Paws::Chime>
