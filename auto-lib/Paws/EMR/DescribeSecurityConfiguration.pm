...
Paws::EMR::DescribeSecurityConfiguration - Arguments for method DescribeSecurityConfiguration on Paws::EMR
...
As an example:
  ...
  $service_obj->DescribeSecurityConfiguration(Att1 => $value1, Att2 => $value2, ...);
