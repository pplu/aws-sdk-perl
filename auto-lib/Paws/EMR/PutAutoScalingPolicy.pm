...
package Paws::EMR::PutAutoScalingPolicy;
  ...
  use Paws::EMR::Types qw/EMR_AutoScalingPolicy/;
  has AutoScalingPolicy => (is => 'ro', isa => EMR_AutoScalingPolicy, required => 1, predicate => 1);
...
=head2 B<REQUIRED> AutoScalingPolicy => EMR_AutoScalingPolicy
