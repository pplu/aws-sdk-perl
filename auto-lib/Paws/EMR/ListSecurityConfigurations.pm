...
Paws::EMR::ListSecurityConfigurations - Arguments for method ListSecurityConfigurations on Paws::EMR
...
As an example:
  ...
  $service_obj->ListSecurityConfigurations(Att1 => $value1, Att2 => $value2, ...);
