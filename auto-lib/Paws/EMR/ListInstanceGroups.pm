...
Paws::EMR::ListInstanceGroups - Arguments for method ListInstanceGroups on Paws::EMR
...
As an example:
  ...
  $service_obj->ListInstanceGroups(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for ListInstanceGroups in Paws::EMR
