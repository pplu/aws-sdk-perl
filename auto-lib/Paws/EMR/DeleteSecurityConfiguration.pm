...
Paws::EMR::DeleteSecurityConfiguration - Arguments for method DeleteSecurityConfiguration on Paws::EMR
...
As an example:
  ...
  $service_obj->DeleteSecurityConfiguration(Att1 => $value1, Att2 => $value2, ...);
