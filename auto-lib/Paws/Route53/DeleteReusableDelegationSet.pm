...
Paws::Route53::DeleteReusableDelegationSet - Arguments for method DeleteReusableDelegationSet on Paws::Route53
...
As an example:
  ...
  $service_obj->DeleteReusableDelegationSet(Att1 => $value1, Att2 => $value2, ...);
