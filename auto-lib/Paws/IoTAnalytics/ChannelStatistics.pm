...
Paws::IoTAnalytics::ChannelStatistics
...
As an example, if Att1 is expected to be a Paws::IoTAnalytics::ChannelStatistics object:

  $service_obj->Method(Att1 => { Size => $value, ..., Size => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTAnalytics::ChannelStatistics object:
