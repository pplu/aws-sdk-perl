...
package Paws::IoTSiteWise::InterpolatedAssetPropertyValue;
  use Moose;
...
Paws::IoTSiteWise::InterpolatedAssetPropertyValue
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::InterpolatedAssetPropertyValue object:

  $service_obj->Method(Att1 => { Timestamp => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::InterpolatedAssetPropertyValue object:
