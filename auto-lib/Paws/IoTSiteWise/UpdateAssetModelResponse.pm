...
package Paws::IoTSiteWise::UpdateAssetModelResponse;
  use Moose;
...
Paws::IoTSiteWise::UpdateAssetModelResponse
...
The status of the asset model, which contains a state (C<UPDATING>
