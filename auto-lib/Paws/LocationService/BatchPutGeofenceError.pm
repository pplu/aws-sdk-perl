...
package Paws::LocationService::BatchPutGeofenceError;
  use Moose;
...
Paws::LocationService::BatchPutGeofenceError
...
As an example, if Att1 is expected to be a Paws::LocationService::BatchPutGeofenceError object:

  $service_obj->Method(Att1 => { Error => $value, ..., GeofenceId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LocationService::BatchPutGeofenceError object:
