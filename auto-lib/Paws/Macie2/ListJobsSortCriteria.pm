...
package Paws::Macie2::ListJobsSortCriteria;
  use Moose;
...
Paws::Macie2::ListJobsSortCriteria
...
As an example, if Att1 is expected to be a Paws::Macie2::ListJobsSortCriteria object:

  $service_obj->Method(Att1 => { AttributeName => $value, ..., OrderBy => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Macie2::ListJobsSortCriteria object:
