...
package Paws::Macie2::DomainDetails;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Macie2::DomainDetails object:

  $service_obj->Method(Att1 => { DomainName => $value, ..., DomainName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Macie2::DomainDetails object:
