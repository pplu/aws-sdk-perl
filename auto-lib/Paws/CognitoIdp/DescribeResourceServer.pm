...
Paws::CognitoIdp::DescribeResourceServer - Arguments for method DescribeResourceServer on Paws::CognitoIdp
...
As an example:
  ...
  $service_obj->DescribeResourceServer(Att1 => $value1, Att2 => $value2, ...);
