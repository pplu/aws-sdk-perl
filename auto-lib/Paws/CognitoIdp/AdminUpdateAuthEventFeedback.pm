...
package Paws::CognitoIdp::AdminUpdateAuthEventFeedback;
  ...
  has EventId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has FeedbackValue => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cognito-idp/AdminUpdateAuthEventFeedback>
