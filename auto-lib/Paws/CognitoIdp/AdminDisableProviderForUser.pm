...
Paws::CognitoIdp::AdminDisableProviderForUser - Arguments for method AdminDisableProviderForUser on Paws::CognitoIdp
...
As an example:
  ...
  $service_obj->AdminDisableProviderForUser(Att1 => $value1, Att2 => $value2, ...);
