...
Paws::CognitoIdp::GetIdentityProviderByIdentifier - Arguments for method GetIdentityProviderByIdentifier on Paws::CognitoIdp
...
As an example:
  ...
  $service_obj->GetIdentityProviderByIdentifier(Att1 => $value1, Att2 => $value2, ...);
