...
Paws::CognitoIdp::UpdateResourceServer - Arguments for method UpdateResourceServer on Paws::CognitoIdp
...
As an example:
  ...
  $service_obj->UpdateResourceServer(Att1 => $value1, Att2 => $value2, ...);
