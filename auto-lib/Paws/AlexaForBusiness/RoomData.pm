...
Paws::AlexaForBusiness::RoomData
...
As an example, if Att1 is expected to be a Paws::AlexaForBusiness::RoomData object:

  $service_obj->Method(Att1 => { Description => $value, ..., RoomName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AlexaForBusiness::RoomData object:
