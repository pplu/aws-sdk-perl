...
package Paws::AlexaForBusiness::DeleteUser;
  ...
  has EnrollmentId => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
=head1 SYNOPSIS
    ...
    my $DeleteUserResponse = $a4b->DeleteUser(
      EnrollmentId => 'MyEnrollmentId',
      UserArn      => 'MyArn',            # OPTIONAL
    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/a4b/DeleteUser>
