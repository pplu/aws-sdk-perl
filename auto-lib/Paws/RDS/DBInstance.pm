...
package Paws::RDS::DBInstance;
  ...
  use Paws::RDS::Types qw/RDS_DBInstanceRole RDS_DBSecurityGroupMembership RDS_DomainMembership RDS_VpcSecurityGroupMembership RDS_ProcessorFeature RDS_DBInstanceStatusInfo RDS_Endpoint RDS_PendingModifiedValues RDS_DBSubnetGroup RDS_DBParameterGroupStatus RDS_OptionGroupMembership/;
