...
Paws::RDS::DescribeDBClusterParameterGroups - Arguments for method DescribeDBClusterParameterGroups on Paws::RDS
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DescribeDBClusterParameterGroups.

As an example:

  $service_obj->DescribeDBClusterParameterGroups(Att1 => $value1, Att2 => $value2, ...);
