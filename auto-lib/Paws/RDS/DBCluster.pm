...
package Paws::RDS::DBCluster;
  ...
  use Paws::RDS::Types qw/RDS_DBClusterRole RDS_VpcSecurityGroupMembership RDS_DBClusterMember RDS_DBClusterOptionGroupStatus RDS_ScalingConfigurationInfo/;
