package Paws::SageMaker::ProcessingClusterConfig;
  use Moose;
...
Paws::SageMaker::ProcessingClusterConfig
...
As an example, if Att1 is expected to be a Paws::SageMaker::ProcessingClusterConfig object:

  $service_obj->Method(Att1 => { InstanceCount => $value, ..., VolumeSizeInGB => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::ProcessingClusterConfig object:
