...
=head1 SYNOPSIS
    ...
    my $ListEndpointConfigsOutput = $sagemaker->ListEndpointConfigs(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/sagemaker/ListEndpointConfigs>
