...
package Paws::SageMaker::TrainingSpecification;
  use Moo;
  use Types::Standard qw/ArrayRef Str Undef Bool/;
  use Paws::SageMaker::Types qw/SageMaker_ChannelSpecification SageMaker_MetricDefinition SageMaker_HyperParameterSpecification SageMaker_HyperParameterTuningJobObjective/;
  has MetricDefinitions => (is => 'ro', isa => ArrayRef[SageMaker_MetricDefinition]);
  has SupportedHyperParameters => (is => 'ro', isa => ArrayRef[SageMaker_HyperParameterSpecification]);
  has SupportedTrainingInstanceTypes => (is => 'ro', isa => ArrayRef[Str|Undef], required => 1);
  has SupportedTuningJobObjectiveMetrics => (is => 'ro', isa => ArrayRef[SageMaker_HyperParameterTuningJobObjective]);
  has SupportsDistributedTraining => (is => 'ro', isa => Bool);
  has TrainingChannels => (is => 'ro', isa => ArrayRef[SageMaker_ChannelSpecification], required => 1);
  ...
  'types' => {
               ...
               'SupportedTuningJobObjectiveMetrics' => {
                                                         'type' => 'ArrayRef[SageMaker_HyperParameterTuningJobObjective]',
               ...
               'TrainingChannels' => {
                                       'type' => 'ArrayRef[SageMaker_ChannelSpecification]',
                                       'class' => 'Paws::SageMaker::ChannelSpecification'
                                     },
               'SupportedHyperParameters' => {
                                               'class' => 'Paws::SageMaker::HyperParameterSpecification',
                                               'type' => 'ArrayRef[SageMaker_HyperParameterSpecification]'
                                             }
             },
  'IsRequired' => {
                    'TrainingImage' => 1,
                    'SupportedTrainingInstanceTypes' => 1,
                    'TrainingChannels' => 1
                  }
}
;
...
=head2 SupportedHyperParameters => ArrayRef[SageMaker_HyperParameterSpecification]
...
=head2 SupportedTuningJobObjectiveMetrics => ArrayRef[SageMaker_HyperParameterTuningJobObjective]
...
=head2 B<REQUIRED> TrainingChannels => ArrayRef[SageMaker_ChannelSpecification]
