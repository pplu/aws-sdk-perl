...
package Paws::SageMaker::ListNotebookInstances;
  ...
  has AdditionalCodeRepositoryEquals => (is => 'ro', isa => Str, predicate => 1);
  has CreationTimeAfter => (is => 'ro', isa => Str, predicate => 1);
  has CreationTimeBefore => (is => 'ro', isa => Str, predicate => 1);
  has DefaultCodeRepositoryContains => (is => 'ro', isa => Str, predicate => 1);
  has LastModifiedTimeAfter => (is => 'ro', isa => Str, predicate => 1);
  has LastModifiedTimeBefore => (is => 'ro', isa => Str, predicate => 1);
  has MaxResults => (is => 'ro', isa => Int, predicate => 1);
  has NameContains => (is => 'ro', isa => Str, predicate => 1);
  has NextToken => (is => 'ro', isa => Str, predicate => 1);
  has NotebookInstanceLifecycleConfigNameContains => (is => 'ro', isa => Str, predicate => 1);
  has SortBy => (is => 'ro', isa => Str, predicate => 1);
  has SortOrder => (is => 'ro', isa => Str, predicate => 1);
  has StatusEquals => (is => 'ro', isa => Str, predicate => 1);
