...
package Paws::SageMaker::TrainingJobDefinition;
  ...
  use Paws::SageMaker::Types qw/SageMaker_ResourceConfig SageMaker_HyperParameters SageMaker_OutputDataConfig SageMaker_Channel SageMaker_StoppingCondition/;
