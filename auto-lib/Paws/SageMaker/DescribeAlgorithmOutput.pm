...
package Paws::SageMaker::DescribeAlgorithmOutput;
  ...
  use Paws::SageMaker::Types qw/SageMaker_AlgorithmStatusDetails SageMaker_AlgorithmValidationSpecification SageMaker_TrainingSpecification SageMaker_InferenceSpecification/;
