...
As an example, if Att1 is expected to be a Paws::SageMaker::Parent object:

  $service_obj->Method(Att1 => { ExperimentName => $value, ..., TrialName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::Parent object:
