...
package Paws::SageMaker::GetSearchSuggestions;
  ...
  use Paws::SageMaker::Types qw/SageMaker_SuggestionQuery/;
  has Resource => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has SuggestionQuery => (is => 'ro', isa => SageMaker_SuggestionQuery, predicate => 1);
  ...
  'types' => {
               'SuggestionQuery' => {
                                      'type' => 'SageMaker_SuggestionQuery',
                                      'class' => 'Paws::SageMaker::SuggestionQuery'
                                    },
               'Resource' => {
                               'type' => 'Str'
                             }
...
=head2 SuggestionQuery => SageMaker_SuggestionQuery
