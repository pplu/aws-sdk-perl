...
package Paws::GlobalAccelerator::CustomRoutingDestinationDescription;
  use Moose;
...
Paws::GlobalAccelerator::CustomRoutingDestinationDescription
...
As an example, if Att1 is expected to be a Paws::GlobalAccelerator::CustomRoutingDestinationDescription object:

  $service_obj->Method(Att1 => { FromPort => $value, ..., ToPort => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GlobalAccelerator::CustomRoutingDestinationDescription object:
