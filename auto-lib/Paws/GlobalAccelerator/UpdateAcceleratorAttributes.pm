...
package Paws::GlobalAccelerator::UpdateAcceleratorAttributes;
  ...
  has AcceleratorArn => (is => 'ro', isa => Str, predicate => 1);
  has FlowLogsEnabled => (is => 'ro', isa => Bool, predicate => 1);
  has FlowLogsS3Bucket => (is => 'ro', isa => Str, predicate => 1);
  has FlowLogsS3Prefix => (is => 'ro', isa => Str, predicate => 1);
