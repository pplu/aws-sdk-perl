...
package Paws::Kendra::TextDocumentStatistics;
  use Moose;
  has IndexedTextBytes => (is => 'ro', isa => 'Int', required => 1);
...
As an example, if Att1 is expected to be a Paws::Kendra::TextDocumentStatistics object:
  ...
  $service_obj->Method(Att1 => { IndexedTextBytes => $value, ..., IndexedTextDocumentsCount => $value  });
...
=head2 B<REQUIRED> IndexedTextBytes => Int
