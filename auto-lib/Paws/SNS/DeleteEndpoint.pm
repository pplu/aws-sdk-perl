...
Paws::SNS::DeleteEndpoint - Arguments for method DeleteEndpoint on Paws::SNS
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteEndpoint.
