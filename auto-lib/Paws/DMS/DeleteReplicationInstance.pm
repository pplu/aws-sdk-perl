...
Paws::DMS::DeleteReplicationInstance - Arguments for method DeleteReplicationInstance on Paws::DMS
...
As an example:
  ...
  $service_obj->DeleteReplicationInstance(Att1 => $value1, Att2 => $value2, ...);
