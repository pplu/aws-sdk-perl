...
Paws::DMS::DescribeReplicationTasks - Arguments for method DescribeReplicationTasks on Paws::DMS
...
As an example:
  ...
  $service_obj->DescribeReplicationTasks(Att1 => $value1, Att2 => $value2, ...);
