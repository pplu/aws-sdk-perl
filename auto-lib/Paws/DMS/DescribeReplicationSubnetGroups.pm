...
Paws::DMS::DescribeReplicationSubnetGroups - Arguments for method DescribeReplicationSubnetGroups on Paws::DMS
...
As an example:
  ...
  $service_obj->DescribeReplicationSubnetGroups(Att1 => $value1, Att2 => $value2, ...);
