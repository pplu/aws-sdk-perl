...
package Paws::DMS::DescribePendingMaintenanceActions;
  ...
  has ReplicationInstanceArn => (is => 'ro', isa => Str, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/dms/DescribePendingMaintenanceActions>
