...
Paws::DMS::DescribeReplicationInstances - Arguments for method DescribeReplicationInstances on Paws::DMS
...
As an example:
  ...
  $service_obj->DescribeReplicationInstances(Att1 => $value1, Att2 => $value2, ...);
