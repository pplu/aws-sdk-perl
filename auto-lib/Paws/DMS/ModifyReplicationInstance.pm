...
Paws::DMS::ModifyReplicationInstance - Arguments for method ModifyReplicationInstance on Paws::DMS
...
As an example:
  ...
  $service_obj->ModifyReplicationInstance(Att1 => $value1, Att2 => $value2, ...);
