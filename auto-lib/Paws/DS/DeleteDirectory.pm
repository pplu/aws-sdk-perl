...
Paws::DS::DeleteDirectory - Arguments for method DeleteDirectory on Paws::DS
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteDirectory.
