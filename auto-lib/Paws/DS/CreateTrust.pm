...
package Paws::DS::CreateTrust;
  ...
  has ConditionalForwarderIpAddrs => (is => 'ro', isa => ArrayRef[Str|Undef], predicate => 1);
  has DirectoryId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has RemoteDomainName => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has SelectiveAuth => (is => 'ro', isa => Str, predicate => 1);
  has TrustDirection => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has TrustPassword => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has TrustType => (is => 'ro', isa => Str, predicate => 1);
