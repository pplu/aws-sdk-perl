...
package Paws::CodeStarConnections::VpcConfiguration;
  use Moose;
...
Paws::CodeStarConnections::VpcConfiguration
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::VpcConfiguration object:

  $service_obj->Method(Att1 => { SecurityGroupIds => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::VpcConfiguration object:
