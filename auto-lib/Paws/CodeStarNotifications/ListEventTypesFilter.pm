package Paws::CodeStarNotifications::ListEventTypesFilter;
  use Moose;
...
Paws::CodeStarNotifications::ListEventTypesFilter
...
As an example, if Att1 is expected to be a Paws::CodeStarNotifications::ListEventTypesFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarNotifications::ListEventTypesFilter object:
