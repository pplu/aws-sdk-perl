...
Paws::CodeDeploy::GetDeploymentConfig - Arguments for method GetDeploymentConfig on Paws::CodeDeploy
...
As an example:
  ...
  $service_obj->GetDeploymentConfig(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for GetDeploymentConfig in Paws::CodeDeploy
