...
Paws::ES::DeleteElasticsearchServiceRole - Arguments for method DeleteElasticsearchServiceRole on Paws::ES
...
As an example:
  ...
  $service_obj->DeleteElasticsearchServiceRole(Att1 => $value1, Att2 => $value2, ...);
