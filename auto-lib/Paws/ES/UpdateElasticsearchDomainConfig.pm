...
package Paws::ES::UpdateElasticsearchDomainConfig;
  ...
  use Paws::ES::Types qw/ES_SnapshotOptions ES_AdvancedOptions ES_EBSOptions ES_LogPublishingOptions ES_ElasticsearchClusterConfig ES_CognitoOptions ES_DomainEndpointOptions ES_VPCOptions/;
