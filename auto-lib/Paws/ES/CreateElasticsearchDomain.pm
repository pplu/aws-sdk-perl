...
package Paws::ES::CreateElasticsearchDomain;
  ...
  use Paws::ES::Types qw/ES_NodeToNodeEncryptionOptions ES_EBSOptions ES_AdvancedOptions ES_SnapshotOptions ES_VPCOptions ES_EncryptionAtRestOptions ES_DomainEndpointOptions ES_CognitoOptions ES_LogPublishingOptions ES_ElasticsearchClusterConfig/;
  ...
  has DomainEndpointOptions => (is => 'ro', isa => ES_DomainEndpointOptions, predicate => 1);
