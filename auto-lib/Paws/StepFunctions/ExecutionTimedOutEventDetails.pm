package Paws::StepFunctions::ExecutionTimedOutEventDetails;
  use Moose;
...
Paws::StepFunctions::ExecutionTimedOutEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::ExecutionTimedOutEventDetails object:

  $service_obj->Method(Att1 => { Cause => $value, ..., Error => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::ExecutionTimedOutEventDetails object:
