...
Paws::StepFunctions::ActivitySucceededEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::ActivitySucceededEventDetails object:

  $service_obj->Method(Att1 => { Output => $value, ..., Output => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::ActivitySucceededEventDetails object:
