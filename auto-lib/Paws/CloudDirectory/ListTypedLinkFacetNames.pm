...
Paws::CloudDirectory::ListTypedLinkFacetNames - Arguments for method ListTypedLinkFacetNames on Paws::CloudDirectory
...
As an example:
  ...
  $service_obj->ListTypedLinkFacetNames(Att1 => $value1, Att2 => $value2, ...);
