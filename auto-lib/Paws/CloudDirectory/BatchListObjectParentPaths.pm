package Paws::CloudDirectory::BatchListObjectParentPaths;
  use Moose;
...
Paws::CloudDirectory::BatchListObjectParentPaths
...
As an example, if Att1 is expected to be a Paws::CloudDirectory::BatchListObjectParentPaths object:

  $service_obj->Method(Att1 => { MaxResults => $value, ..., ObjectReference => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudDirectory::BatchListObjectParentPaths object:
