...
Paws::CloudDirectory::PutSchemaFromJson - Arguments for method PutSchemaFromJson on Paws::CloudDirectory
...
As an example:
  ...
  $service_obj->PutSchemaFromJson(Att1 => $value1, Att2 => $value2, ...);
