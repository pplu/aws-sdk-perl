...
package Paws::Pinpoint::CreateExportJob;
  ...
  use Paws::Pinpoint::Types qw/Pinpoint_ExportJobRequest/;
  has ApplicationId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has ExportJobRequest => (is => 'ro', isa => Pinpoint_ExportJobRequest, required => 1, predicate => 1);
  ...
  'types' => {
               ...
               'ExportJobRequest' => {
                                       'type' => 'Pinpoint_ExportJobRequest',
                                       'class' => 'Paws::Pinpoint::ExportJobRequest'
                                     }
             },
  'IsRequired' => {
                    'ApplicationId' => 1,
...
=head2 B<REQUIRED> ExportJobRequest => Pinpoint_ExportJobRequest
