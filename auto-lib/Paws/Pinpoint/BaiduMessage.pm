...
package Paws::Pinpoint::BaiduMessage;
  ...
  use Paws::Pinpoint::Types qw/Pinpoint_MapOfListOf__string Pinpoint_MapOf__string/;
...
As an example, if Att1 is expected to be a Paws::Pinpoint::BaiduMessage object:

  $service_obj->Method(Att1 => { Action => $value, ..., Url => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::BaiduMessage object:
...
default value and maximum supported time is 604,800 seconds (7 days).
