...
Paws::Pinpoint::DeleteApnsVoipSandboxChannel - Arguments for method DeleteApnsVoipSandboxChannel on Paws::Pinpoint
...
As an example:
  ...
  $service_obj->DeleteApnsVoipSandboxChannel(Att1 => $value1, Att2 => $value2, ...);
