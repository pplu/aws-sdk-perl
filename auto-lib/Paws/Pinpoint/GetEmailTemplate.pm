...
package Paws::Pinpoint::GetEmailTemplate;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pinpoint::GetEmailTemplateResponse');
1;
...
Paws::Pinpoint::GetEmailTemplate - Arguments for method GetEmailTemplate on L<Paws::Pinpoint>
...
=head1 SYNOPSIS
    ...
    my $GetEmailTemplateResponse = $pinpoint->GetEmailTemplate(
      TemplateName => 'My__string',
      Version      => 'My__string',    # OPTIONAL
    );

    # Results:
    my $EmailTemplateResponse =
      $GetEmailTemplateResponse->EmailTemplateResponse;

    # Returns a L<Paws::Pinpoint::GetEmailTemplateResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pinpoint/GetEmailTemplate>
...
This class forms part of L<Paws>, documenting arguments for method GetEmailTemplate in L<Paws::Pinpoint>
