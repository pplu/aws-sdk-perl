...
package Paws::Pinpoint::MessageRequest;
  ...
  use Paws::Pinpoint::Types qw/Pinpoint_MapOfAddressConfiguration Pinpoint_MapOf__string Pinpoint_MapOfEndpointSendConfiguration Pinpoint_DirectMessageConfiguration/;
