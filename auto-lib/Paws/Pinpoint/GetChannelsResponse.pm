...
As an example, if Att1 is expected to be a Paws::Pinpoint::GetChannelsResponse object:

  $service_obj->Method(Att1 => { ChannelsResponse => $value, ..., ChannelsResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::GetChannelsResponse object:

  $result = $service_obj->Method(...);
  $result->Att1->ChannelsResponse
