...
package Paws::Pinpoint::EndpointRequest;
  ...
  use Paws::Pinpoint::Types qw/Pinpoint_EndpointUser Pinpoint_MapOf__double Pinpoint_EndpointDemographic Pinpoint_EndpointLocation Pinpoint_MapOfListOf__string/;
