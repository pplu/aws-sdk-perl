...
=head1 SYNOPSIS
    ...
    my $GetEventStreamResponse = $pinpoint->GetEventStream(
      ApplicationId => 'My__string',

    );

    # Results:
    my $EventStream = $GetEventStreamResponse->EventStream;

    # Returns a L<Paws::Pinpoint::GetEventStreamResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pinpoint/GetEventStream>
