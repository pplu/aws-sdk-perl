...
package Paws::Pinpoint::GetApplicationDateRangeKpi;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetApplicationDateRangeKpi');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/apps/{application-id}/kpis/daterange/{kpi-name}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pinpoint::GetApplicationDateRangeKpiResponse');
1;
...
Paws::Pinpoint::GetApplicationDateRangeKpi - Arguments for method GetApplicationDateRangeKpi on L<Paws::Pinpoint>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetApplicationDateRangeKpi on the
L<Amazon Pinpoint|Paws::Pinpoint> service. Use the attributes of this class
as arguments to method GetApplicationDateRangeKpi.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetApplicationDateRangeKpi.

=head1 SYNOPSIS

    my $pinpoint = Paws->service('Pinpoint');
    my $GetApplicationDateRangeKpiResponse =
    ...
    # Results:
    my $ApplicationDateRangeKpiResponse =
      $GetApplicationDateRangeKpiResponse->ApplicationDateRangeKpiResponse;

    # Returns a L<Paws::Pinpoint::GetApplicationDateRangeKpiResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pinpoint/GetApplicationDateRangeKpi>
...
This class forms part of L<Paws>, documenting arguments for method GetApplicationDateRangeKpi in L<Paws::Pinpoint>
