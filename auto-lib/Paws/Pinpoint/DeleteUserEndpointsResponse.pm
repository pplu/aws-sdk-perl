...
As an example, if Att1 is expected to be a Paws::Pinpoint::DeleteUserEndpointsResponse object:

  $service_obj->Method(Att1 => { EndpointsResponse => $value, ..., EndpointsResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::DeleteUserEndpointsResponse object:
