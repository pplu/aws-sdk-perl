...
As an example, if Att1 is expected to be a Paws::Pinpoint::DeleteEndpointResponse object:

  $service_obj->Method(Att1 => { EndpointResponse => $value, ..., EndpointResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::DeleteEndpointResponse object:
