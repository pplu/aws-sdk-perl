...
Paws::Pinpoint::GetApplicationSettings - Arguments for method GetApplicationSettings on Paws::Pinpoint
...
As an example:
  ...
  $service_obj->GetApplicationSettings(Att1 => $value1, Att2 => $value2, ...);
