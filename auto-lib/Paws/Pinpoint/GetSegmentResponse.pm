...
As an example, if Att1 is expected to be a Paws::Pinpoint::GetSegmentResponse object:

  $service_obj->Method(Att1 => { SegmentResponse => $value, ..., SegmentResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::GetSegmentResponse object:
