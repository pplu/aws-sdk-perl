...
package Paws::Pinpoint::GetChannels;
  ...
  class_has _returns => (isa => Str, is => 'ro', default => 'Paws::Pinpoint::ChannelsResponse');
...
=head1 SYNOPSIS
    ...
    my $ChannelsResponse = $pinpoint->GetChannels(
      ApplicationId => 'My__string',

    );

    # Results:
    my $Channels = $ChannelsResponse->Channels;

    # Returns a L<Paws::Pinpoint::ChannelsResponse> object.
