...
As an example, if Att1 is expected to be a Paws::Pinpoint::DeleteCampaignResponse object:

  $service_obj->Method(Att1 => { CampaignResponse => $value, ..., CampaignResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::DeleteCampaignResponse object:
