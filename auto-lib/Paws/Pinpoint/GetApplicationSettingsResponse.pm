...
As an example, if Att1 is expected to be a Paws::Pinpoint::GetApplicationSettingsResponse object:

  $service_obj->Method(Att1 => { ApplicationSettingsResource => $value, ..., ApplicationSettingsResource => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::GetApplicationSettingsResponse object:
