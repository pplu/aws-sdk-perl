...
package Paws::Pinpoint::GetSmsTemplate;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetSmsTemplate');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/templates/{template-name}/sms');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pinpoint::GetSmsTemplateResponse');
1;
...
Paws::Pinpoint::GetSmsTemplate - Arguments for method GetSmsTemplate on L<Paws::Pinpoint>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetSmsTemplate on the
L<Amazon Pinpoint|Paws::Pinpoint> service. Use the attributes of this class
as arguments to method GetSmsTemplate.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetSmsTemplate.

=head1 SYNOPSIS

    my $pinpoint = Paws->service('Pinpoint');
    my $GetSmsTemplateResponse = $pinpoint->GetSmsTemplate(
      TemplateName => 'My__string',
      Version      => 'My__string',    # OPTIONAL
    );

    # Results:
    my $SMSTemplateResponse = $GetSmsTemplateResponse->SMSTemplateResponse;

    # Returns a L<Paws::Pinpoint::GetSmsTemplateResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pinpoint/GetSmsTemplate>
...
This class forms part of L<Paws>, documenting arguments for method GetSmsTemplate in L<Paws::Pinpoint>
