...
As an example, if Att1 is expected to be a Paws::Pinpoint::DeleteGcmChannelResponse object:

  $service_obj->Method(Att1 => { GCMChannelResponse => $value, ..., GCMChannelResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::DeleteGcmChannelResponse object:
