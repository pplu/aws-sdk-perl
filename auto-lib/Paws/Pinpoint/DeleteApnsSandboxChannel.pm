...
package Paws::Pinpoint::DeleteApnsSandboxChannel;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pinpoint::DeleteApnsSandboxChannelResponse');
1;
...
Paws::Pinpoint::DeleteApnsSandboxChannel - Arguments for method DeleteApnsSandboxChannel on Paws::Pinpoint
...
As an example:
  ...
  $service_obj->DeleteApnsSandboxChannel(Att1 => $value1, Att2 => $value2, ...);
