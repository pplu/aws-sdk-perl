package Paws::Pinpoint::APNSPushNotificationTemplate;
  use Moose;
...
Paws::Pinpoint::APNSPushNotificationTemplate
...
As an example, if Att1 is expected to be a Paws::Pinpoint::APNSPushNotificationTemplate object:

  $service_obj->Method(Att1 => { Action => $value, ..., Url => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::APNSPushNotificationTemplate object:
