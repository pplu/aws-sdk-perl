...
package Paws::Pinpoint::GetPushTemplate;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetPushTemplate');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/templates/{template-name}/push');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pinpoint::GetPushTemplateResponse');
1;
...
Paws::Pinpoint::GetPushTemplate - Arguments for method GetPushTemplate on L<Paws::Pinpoint>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetPushTemplate on the
L<Amazon Pinpoint|Paws::Pinpoint> service. Use the attributes of this class
as arguments to method GetPushTemplate.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pinpoint/GetPushTemplate>
...
This class forms part of L<Paws>, documenting arguments for method GetPushTemplate in L<Paws::Pinpoint>
