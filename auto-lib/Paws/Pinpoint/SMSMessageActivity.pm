...
package Paws::Pinpoint::SMSMessageActivity;
  use Moose;
  has MessageConfig => (is => 'ro', isa => 'Paws::Pinpoint::JourneySMSMessage');
...
Paws::Pinpoint::SMSMessageActivity
...
As an example, if Att1 is expected to be a Paws::Pinpoint::SMSMessageActivity object:

  $service_obj->Method(Att1 => { MessageConfig => $value, ..., TemplateVersion => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::SMSMessageActivity object:
...
=head2 MessageConfig => L<Paws::Pinpoint::JourneySMSMessage>
