package Paws::Pinpoint::MapOfMessageResult;
  ...
  use Paws::Pinpoint::Types qw/Pinpoint_MessageResult/;

  has Map => (is => 'ro', isa => HashRef[Pinpoint_MessageResult]);

  sub params_map {
    our $Params_map ||= {
                    types => {
                               'Map' => {
                                          type => 'HashRef[Pinpoint_MessageResult]',
                                          class => 'Paws::Pinpoint::MessageResult',
                                        },
                             },
                  };
    return $Params_map;
