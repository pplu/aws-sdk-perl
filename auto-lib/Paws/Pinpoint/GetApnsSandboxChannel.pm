...
Paws::Pinpoint::GetApnsSandboxChannel - Arguments for method GetApnsSandboxChannel on Paws::Pinpoint
...
As an example:
  ...
  $service_obj->GetApnsSandboxChannel(Att1 => $value1, Att2 => $value2, ...);
