...
As an example, if Att1 is expected to be a Paws::Pinpoint::GetSegmentsResponse object:

  $service_obj->Method(Att1 => { SegmentsResponse => $value, ..., SegmentsResponse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::GetSegmentsResponse object:
