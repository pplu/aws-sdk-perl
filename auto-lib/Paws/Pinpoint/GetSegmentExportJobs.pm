...
package Paws::Pinpoint::GetSegmentExportJobs;
  use Moose;
...
Paws::Pinpoint::GetSegmentExportJobs - Arguments for method GetSegmentExportJobs on L<Paws::Pinpoint>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetSegmentExportJobs on the 
L<Amazon Pinpoint|Paws::Pinpoint> service. Use the attributes of this class
as arguments to method GetSegmentExportJobs.
...
As an example:
  ...
  $service_obj->GetSegmentExportJobs(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, documenting arguments for method GetSegmentExportJobs in L<Paws::Pinpoint>
