...
Paws::Pinpoint::DeleteApnsVoipChannel - Arguments for method DeleteApnsVoipChannel on Paws::Pinpoint
...
As an example:
  ...
  $service_obj->DeleteApnsVoipChannel(Att1 => $value1, Att2 => $value2, ...);
