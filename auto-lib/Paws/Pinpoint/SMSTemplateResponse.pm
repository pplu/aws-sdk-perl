package Paws::Pinpoint::SMSTemplateResponse;
  use Moose;
...
Paws::Pinpoint::SMSTemplateResponse
...
As an example, if Att1 is expected to be a Paws::Pinpoint::SMSTemplateResponse object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::SMSTemplateResponse object:
