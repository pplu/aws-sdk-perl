...
Paws::Pinpoint::CreateRecommenderConfiguration
...
As an example, if Att1 is expected to be a Paws::Pinpoint::CreateRecommenderConfiguration object:

  $service_obj->Method(Att1 => { Attributes => $value, ..., RecommendationTransformerUri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pinpoint::CreateRecommenderConfiguration object:
