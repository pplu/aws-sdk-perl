...
package Paws::KinesisAnalytics::Output;
  ...
  use Paws::KinesisAnalytics::Types qw/KinesisAnalytics_KinesisFirehoseOutput KinesisAnalytics_DestinationSchema KinesisAnalytics_KinesisStreamsOutput KinesisAnalytics_LambdaOutput/;
