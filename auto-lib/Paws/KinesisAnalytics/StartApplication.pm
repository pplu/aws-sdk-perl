...
package Paws::KinesisAnalytics::StartApplication;
  ...
  use Paws::KinesisAnalytics::Types qw/KinesisAnalytics_InputConfiguration/;
  has ApplicationName => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has InputConfigurations => (is => 'ro', isa => ArrayRef[KinesisAnalytics_InputConfiguration], required => 1, predicate => 1);
  ...
  'types' => {
               'InputConfigurations' => {
                                          'class' => 'Paws::KinesisAnalytics::InputConfiguration',
                                          'type' => 'ArrayRef[KinesisAnalytics_InputConfiguration]'
                                        },
               'ApplicationName' => {
                                      'type' => 'Str'
                                    }
...
=head2 B<REQUIRED> InputConfigurations => ArrayRef[KinesisAnalytics_InputConfiguration]
