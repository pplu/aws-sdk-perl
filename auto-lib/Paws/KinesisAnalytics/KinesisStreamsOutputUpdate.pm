package Paws::KinesisAnalytics::KinesisStreamsOutputUpdate;
  use Moose;
...
Paws::KinesisAnalytics::KinesisStreamsOutputUpdate
...
As an example, if Att1 is expected to be a Paws::KinesisAnalytics::KinesisStreamsOutputUpdate object:

  $service_obj->Method(Att1 => { ResourceARNUpdate => $value, ..., RoleARNUpdate => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalytics::KinesisStreamsOutputUpdate object:
