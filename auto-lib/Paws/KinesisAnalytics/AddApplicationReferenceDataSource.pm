...
package Paws::KinesisAnalytics::AddApplicationReferenceDataSource;
  ...
  use Paws::KinesisAnalytics::Types qw/KinesisAnalytics_ReferenceDataSource/;
  ...
  has ReferenceDataSource => (is => 'ro', isa => KinesisAnalytics_ReferenceDataSource, required => 1, predicate => 1);
  ...
  'types' => {
               ...
               'ReferenceDataSource' => {
                                          'class' => 'Paws::KinesisAnalytics::ReferenceDataSource',
                                          'type' => 'KinesisAnalytics_ReferenceDataSource'
                                        },
...
=head2 B<REQUIRED> ReferenceDataSource => KinesisAnalytics_ReferenceDataSource
