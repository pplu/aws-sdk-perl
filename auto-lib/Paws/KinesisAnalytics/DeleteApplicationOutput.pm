...
Paws::KinesisAnalytics::DeleteApplicationOutput - Arguments for method DeleteApplicationOutput on Paws::KinesisAnalytics
...
As an example:
  ...
  $service_obj->DeleteApplicationOutput(Att1 => $value1, Att2 => $value2, ...);
