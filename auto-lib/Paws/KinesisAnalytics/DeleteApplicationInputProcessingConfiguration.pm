...
Paws::KinesisAnalytics::DeleteApplicationInputProcessingConfiguration - Arguments for method DeleteApplicationInputProcessingConfiguration on Paws::KinesisAnalytics
...
As an example:
  ...
  $service_obj->DeleteApplicationInputProcessingConfiguration(Att1 => $value1, Att2 => $value2, ...);
