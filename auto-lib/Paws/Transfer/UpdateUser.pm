...
An example is C<your-Amazon-S3-bucket-nameE<gt>/home/username>.
...
inside this policy include C<${Transfer:UserName}>,
C<${Transfer:HomeDirectory}>, and C<${Transfer:HomeBucket}>.
