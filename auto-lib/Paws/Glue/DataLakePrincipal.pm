...
As an example, if Att1 is expected to be a Paws::Glue::DataLakePrincipal object:

  $service_obj->Method(Att1 => { DataLakePrincipalIdentifier => $value, ..., DataLakePrincipalIdentifier => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Glue::DataLakePrincipal object:
