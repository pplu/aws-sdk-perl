...
Paws::Glue::DeleteClassifier - Arguments for method DeleteClassifier on Paws::Glue
...
As an example:
  ...
  $service_obj->DeleteClassifier(Att1 => $value1, Att2 => $value2, ...);
...
Name of the C<Classifier> to remove.
