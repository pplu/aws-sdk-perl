...
package Paws::Glue::StartCrawlerSchedule;
  ...
  has CrawlerName => (is => 'ro', isa => Str, required => 1, predicate => 1);
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/glue/StartCrawlerSchedule>
