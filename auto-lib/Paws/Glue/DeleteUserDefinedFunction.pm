...
Paws::Glue::DeleteUserDefinedFunction - Arguments for method DeleteUserDefinedFunction on Paws::Glue
...
As an example:
  ...
  $service_obj->DeleteUserDefinedFunction(Att1 => $value1, Att2 => $value2, ...);
