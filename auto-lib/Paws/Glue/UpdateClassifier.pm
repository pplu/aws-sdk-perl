...
package Paws::Glue::UpdateClassifier;
  ...
  use Paws::Glue::Types qw/Glue_UpdateJsonClassifierRequest Glue_UpdateXMLClassifierRequest Glue_UpdateGrokClassifierRequest Glue_UpdateCsvClassifierRequest/;
