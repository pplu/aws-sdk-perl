...
package Paws::Glue::RegistryListItem;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Glue::RegistryListItem object:

  $service_obj->Method(Att1 => { CreatedTime => $value, ..., UpdatedTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Glue::RegistryListItem object:
