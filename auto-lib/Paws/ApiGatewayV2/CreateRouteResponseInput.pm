package Paws::ApiGatewayV2::CreateRouteResponseInput;
  use Moose;
...
Paws::ApiGatewayV2::CreateRouteResponseInput
...
As an example, if Att1 is expected to be a Paws::ApiGatewayV2::CreateRouteResponseInput object:

  $service_obj->Method(Att1 => { ModelSelectionExpression => $value, ..., RouteResponseKey => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApiGatewayV2::CreateRouteResponseInput object:
