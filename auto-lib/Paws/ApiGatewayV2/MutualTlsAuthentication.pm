...
package Paws::ApiGatewayV2::MutualTlsAuthentication;
  use Moose;
...
Paws::ApiGatewayV2::MutualTlsAuthentication
...
As an example, if Att1 is expected to be a Paws::ApiGatewayV2::MutualTlsAuthentication object:

  $service_obj->Method(Att1 => { TruststoreUri => $value, ..., TruststoreWarnings => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApiGatewayV2::MutualTlsAuthentication object:
