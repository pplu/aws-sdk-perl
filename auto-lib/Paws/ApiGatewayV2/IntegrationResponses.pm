...
Paws::ApiGatewayV2::IntegrationResponses
...
As an example, if Att1 is expected to be a Paws::ApiGatewayV2::IntegrationResponses object:

  $service_obj->Method(Att1 => { Items => $value, ..., NextToken => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApiGatewayV2::IntegrationResponses object:
