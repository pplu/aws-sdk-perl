...
package Paws::ApiGatewayV2::GetIntegration;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApiGatewayV2::GetIntegrationResponse');
1;
...
=head1 SYNOPSIS
    ...
    my $GetIntegrationResponse = $apigateway->GetIntegration(
      ApiId         => 'My__string',
    ...
    # Results:
    my $ConnectionId   = $GetIntegrationResponse->ConnectionId;
    my $ConnectionType = $GetIntegrationResponse->ConnectionType;
    my $ContentHandlingStrategy =
      $GetIntegrationResponse->ContentHandlingStrategy;
    my $CredentialsArn    = $GetIntegrationResponse->CredentialsArn;
    my $Description       = $GetIntegrationResponse->Description;
    my $IntegrationId     = $GetIntegrationResponse->IntegrationId;
    my $IntegrationMethod = $GetIntegrationResponse->IntegrationMethod;
    my $IntegrationResponseSelectionExpression =
      $GetIntegrationResponse->IntegrationResponseSelectionExpression;
    my $IntegrationType     = $GetIntegrationResponse->IntegrationType;
    my $IntegrationUri      = $GetIntegrationResponse->IntegrationUri;
    my $PassthroughBehavior = $GetIntegrationResponse->PassthroughBehavior;
    my $RequestParameters   = $GetIntegrationResponse->RequestParameters;
    my $RequestTemplates    = $GetIntegrationResponse->RequestTemplates;
    my $TemplateSelectionExpression =
      $GetIntegrationResponse->TemplateSelectionExpression;
    my $TimeoutInMillis = $GetIntegrationResponse->TimeoutInMillis;

    # Returns a L<Paws::ApiGatewayV2::GetIntegrationResponse> object.
