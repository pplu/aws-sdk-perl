...
package Paws::SESv2::CustomVerificationEmailTemplateMetadata;
  use Moose;
...
Paws::SESv2::CustomVerificationEmailTemplateMetadata
...
As an example, if Att1 is expected to be a Paws::SESv2::CustomVerificationEmailTemplateMetadata object:

  $service_obj->Method(Att1 => { FailureRedirectionURL => $value, ..., TemplateSubject => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SESv2::CustomVerificationEmailTemplateMetadata object:
