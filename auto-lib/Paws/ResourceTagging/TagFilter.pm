package Paws::ResourceTagging::TagFilter;
  use Moose;
...
Paws::ResourceTagging::TagFilter
...
As an example, if Att1 is expected to be a Paws::ResourceTagging::TagFilter object:

  $service_obj->Method(Att1 => { Key => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ResourceTagging::TagFilter object:
