...
package Paws::Proton::CompatibleEnvironmentTemplate;
  use Moose;
...
Paws::Proton::CompatibleEnvironmentTemplate
...
As an example, if Att1 is expected to be a Paws::Proton::CompatibleEnvironmentTemplate object:

  $service_obj->Method(Att1 => { MajorVersion => $value, ..., TemplateName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Proton::CompatibleEnvironmentTemplate object:
