...
package Paws::ElasticTranscoder::JobInput;
  ...
  use Paws::ElasticTranscoder::Types qw/ElasticTranscoder_Encryption ElasticTranscoder_TimeSpan ElasticTranscoder_DetectedProperties ElasticTranscoder_InputCaptions/;
