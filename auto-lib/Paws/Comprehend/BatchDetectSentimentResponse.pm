...
package Paws::Comprehend::BatchDetectSentimentResponse;
  ...
  has ResultList => (is => 'ro', isa => 'ArrayRef[Paws::Comprehend::BatchDetectSentimentItemResult]', required => 1);
...
=head2 B<REQUIRED> ResultList => ArrayRef[L<Paws::Comprehend::BatchDetectSentimentItemResult>]
