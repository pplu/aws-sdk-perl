...
package Paws::Comprehend::ListEntityRecognizers;
  ...
  use Paws::Comprehend::Types qw/Comprehend_EntityRecognizerFilter/;
  has Filter => (is => 'ro', isa => Comprehend_EntityRecognizerFilter, predicate => 1);
  ...
  'types' => {
               ...
               'Filter' => {
                             'type' => 'Comprehend_EntityRecognizerFilter',
                             'class' => 'Paws::Comprehend::EntityRecognizerFilter'
                           }
             }
}
;
...
=head2 Filter => Comprehend_EntityRecognizerFilter
