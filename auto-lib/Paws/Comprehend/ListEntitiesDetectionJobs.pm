...
package Paws::Comprehend::ListEntitiesDetectionJobs;
  ...
  use Paws::Comprehend::Types qw/Comprehend_EntitiesDetectionJobFilter/;
  has Filter => (is => 'ro', isa => Comprehend_EntitiesDetectionJobFilter, predicate => 1);
  ...
  'types' => {
               'Filter' => {
                             'class' => 'Paws::Comprehend::EntitiesDetectionJobFilter',
                             'type' => 'Comprehend_EntitiesDetectionJobFilter'
                           },
               'NextToken' => {
                                'type' => 'Str'
                              },
...
=head2 Filter => Comprehend_EntitiesDetectionJobFilter
