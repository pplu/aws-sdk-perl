...
package Paws::Comprehend::BatchDetectSyntaxResponse;
  ...
  has ResultList => (is => 'ro', isa => 'ArrayRef[Paws::Comprehend::BatchDetectSyntaxItemResult]', required => 1);
...
=head2 B<REQUIRED> ResultList => ArrayRef[L<Paws::Comprehend::BatchDetectSyntaxItemResult>]
