...
package Paws::Comprehend::PiiEntitiesDetectionJobFilter;
  use Moose;
...
Paws::Comprehend::PiiEntitiesDetectionJobFilter
...
As an example, if Att1 is expected to be a Paws::Comprehend::PiiEntitiesDetectionJobFilter object:

  $service_obj->Method(Att1 => { JobName => $value, ..., SubmitTimeBefore => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Comprehend::PiiEntitiesDetectionJobFilter object:
