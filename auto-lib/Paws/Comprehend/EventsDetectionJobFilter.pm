...
package Paws::Comprehend::EventsDetectionJobFilter;
  use Moose;
...
Paws::Comprehend::EventsDetectionJobFilter
...
As an example, if Att1 is expected to be a Paws::Comprehend::EventsDetectionJobFilter object:

  $service_obj->Method(Att1 => { JobName => $value, ..., SubmitTimeBefore => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Comprehend::EventsDetectionJobFilter object:
