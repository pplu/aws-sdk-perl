...
package Paws::Comprehend::ListTopicsDetectionJobs;
  ...
  use Paws::Comprehend::Types qw/Comprehend_TopicsDetectionJobFilter/;
  has Filter => (is => 'ro', isa => Comprehend_TopicsDetectionJobFilter, predicate => 1);
  ...
  'types' => {
               'Filter' => {
                             'class' => 'Paws::Comprehend::TopicsDetectionJobFilter',
                             'type' => 'Comprehend_TopicsDetectionJobFilter'
                           },
               'NextToken' => {
                                'type' => 'Str'
                              },
...
=head2 Filter => Comprehend_TopicsDetectionJobFilter
