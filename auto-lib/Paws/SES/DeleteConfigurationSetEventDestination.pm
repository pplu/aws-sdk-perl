...
Paws::SES::DeleteConfigurationSetEventDestination - Arguments for method DeleteConfigurationSetEventDestination on Paws::SES
...
As an example:
  ...
  $service_obj->DeleteConfigurationSetEventDestination(Att1 => $value1, Att2 => $value2, ...);
