...
Paws::SES::CreateConfigurationSetTrackingOptions - Arguments for method CreateConfigurationSetTrackingOptions on Paws::SES
...
As an example:
  ...
  $service_obj->CreateConfigurationSetTrackingOptions(Att1 => $value1, Att2 => $value2, ...);
