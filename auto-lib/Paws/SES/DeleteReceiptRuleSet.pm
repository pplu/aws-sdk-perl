...
Paws::SES::DeleteReceiptRuleSet - Arguments for method DeleteReceiptRuleSet on Paws::SES
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteReceiptRuleSet.

As an example:

  $service_obj->DeleteReceiptRuleSet(Att1 => $value1, Att2 => $value2, ...);
