...
Paws::SES::DescribeActiveReceiptRuleSet - Arguments for method DescribeActiveReceiptRuleSet on Paws::SES
...
As an example:
  ...
  $service_obj->DescribeActiveReceiptRuleSet(Att1 => $value1, Att2 => $value2, ...);
