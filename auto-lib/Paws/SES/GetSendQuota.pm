...
Paws::SES::GetSendQuota - Arguments for method GetSendQuota on Paws::SES
...
As an example:
  ...
  $service_obj->GetSendQuota(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for GetSendQuota in Paws::SES
