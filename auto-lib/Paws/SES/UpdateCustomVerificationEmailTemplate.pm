...
package Paws::SES::UpdateCustomVerificationEmailTemplate;
  ...
  has FailureRedirectionURL => (is => 'ro', isa => Str, predicate => 1);
  has FromEmailAddress => (is => 'ro', isa => Str, predicate => 1);
  has SuccessRedirectionURL => (is => 'ro', isa => Str, predicate => 1);
  has TemplateContent => (is => 'ro', isa => Str, predicate => 1);
  has TemplateName => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has TemplateSubject => (is => 'ro', isa => Str, predicate => 1);
