...
Paws::SES::VerifyDomainIdentity - Arguments for method VerifyDomainIdentity on Paws::SES
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to VerifyDomainIdentity.

As an example:

  $service_obj->VerifyDomainIdentity(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for VerifyDomainIdentity in Paws::SES
