...
Paws::SES::GetIdentityMailFromDomainAttributes - Arguments for method GetIdentityMailFromDomainAttributes on Paws::SES
...
As an example:
  ...
  $service_obj->GetIdentityMailFromDomainAttributes(Att1 => $value1, Att2 => $value2, ...);
