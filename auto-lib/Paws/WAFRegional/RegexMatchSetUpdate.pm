...
package Paws::WAFRegional::RegexMatchSetUpdate;
  use Moo;
  use Types::Standard qw/Str/;
  use Paws::WAFRegional::Types qw/WAFRegional_RegexMatchTuple/;
  has Action => (is => 'ro', isa => Str, required => 1);
  has RegexMatchTuple => (is => 'ro', isa => WAFRegional_RegexMatchTuple, required => 1);
  ...
  'types' => {
               ...
               'RegexMatchTuple' => {
                                      'type' => 'WAFRegional_RegexMatchTuple',
...
Paws::WAFRegional::RegexMatchSetUpdate
...
As an example, if Att1 is expected to be a Paws::WAFRegional::RegexMatchSetUpdate object:

  $service_obj->Method(Att1 => { Action => $value, ..., RegexMatchTuple => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::RegexMatchSetUpdate object:
...
=head2 B<REQUIRED> RegexMatchTuple => WAFRegional_RegexMatchTuple
