...
package Paws::WAFRegional::PutLoggingConfiguration;
  ...
  has LoggingConfiguration => (is => 'ro', isa => WAFRegional_LoggingConfiguration, required => 1, predicate => 1);
...
=head2 B<REQUIRED> LoggingConfiguration => WAFRegional_LoggingConfiguration
