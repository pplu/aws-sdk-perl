package Paws::WAFRegional::RegexPatternSetSummary;
  use Moose;
...
Paws::WAFRegional::RegexPatternSetSummary
...
As an example, if Att1 is expected to be a Paws::WAFRegional::RegexPatternSetSummary object:

  $service_obj->Method(Att1 => { Name => $value, ..., RegexPatternSetId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::RegexPatternSetSummary object:
