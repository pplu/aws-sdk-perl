package Paws::WAFRegional::SqlInjectionMatchSetSummary;
  use Moose;
...
Paws::WAFRegional::SqlInjectionMatchSetSummary
...
As an example, if Att1 is expected to be a Paws::WAFRegional::SqlInjectionMatchSetSummary object:

  $service_obj->Method(Att1 => { Name => $value, ..., SqlInjectionMatchSetId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::SqlInjectionMatchSetSummary object:
