...
Paws::WAFRegional::DeleteRegexMatchSet - Arguments for method DeleteRegexMatchSet on Paws::WAFRegional
...
As an example:
  ...
  $service_obj->DeleteRegexMatchSet(Att1 => $value1, Att2 => $value2, ...);
