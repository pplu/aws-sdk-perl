...
Paws::WAFRegional::DeleteRateBasedRule - Arguments for method DeleteRateBasedRule on Paws::WAFRegional
...
As an example:
  ...
  $service_obj->DeleteRateBasedRule(Att1 => $value1, Att2 => $value2, ...);
