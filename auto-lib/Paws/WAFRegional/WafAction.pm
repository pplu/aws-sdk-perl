package Paws::WAFRegional::WafAction;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAFRegional::WafAction object:

  $service_obj->Method(Att1 => { Type => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::WafAction object:
