...
Paws::WAFRegional::GetRateBasedRuleManagedKeys - Arguments for method GetRateBasedRuleManagedKeys on Paws::WAFRegional
...
As an example:
  ...
  $service_obj->GetRateBasedRuleManagedKeys(Att1 => $value1, Att2 => $value2, ...);
