...
package Paws::WAFRegional::ActivatedRule;
  ...
  use Paws::WAFRegional::Types qw/WAFRegional_ExcludedRule WAFRegional_WafAction WAFRegional_WafOverrideAction/;
...
Paws::WAFRegional::ActivatedRule
...
As an example, if Att1 is expected to be a Paws::WAFRegional::ActivatedRule object:

  $service_obj->Method(Att1 => { Action => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::ActivatedRule object:
