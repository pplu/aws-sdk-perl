package Paws::WAFRegional::ExcludedRule;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAFRegional::ExcludedRule object:

  $service_obj->Method(Att1 => { RuleId => $value, ..., RuleId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::ExcludedRule object:
