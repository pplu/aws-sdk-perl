...
package Paws::WAFRegional::GetSampledRequests;
  ...
  use Paws::WAFRegional::Types qw/WAFRegional_TimeWindow/;
  has MaxItems => (is => 'ro', isa => Int, required => 1, predicate => 1);
  has RuleId => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has TimeWindow => (is => 'ro', isa => WAFRegional_TimeWindow, required => 1, predicate => 1);
...
=head2 B<REQUIRED> TimeWindow => WAFRegional_TimeWindow
