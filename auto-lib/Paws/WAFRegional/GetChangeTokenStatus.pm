...
=head1 SYNOPSIS
    ...
    my $GetChangeTokenStatusResponse = $waf -regional->GetChangeTokenStatus(
      {
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/waf-regional/GetChangeTokenStatus>
