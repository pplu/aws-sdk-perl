...
Paws::WAFRegional::SqlInjectionMatchSetUpdate
...
As an example, if Att1 is expected to be a Paws::WAFRegional::SqlInjectionMatchSetUpdate object:

  $service_obj->Method(Att1 => { Action => $value, ..., SqlInjectionMatchTuple => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::SqlInjectionMatchSetUpdate object:
