...
Paws::WAFRegional::CreateRegexPatternSet - Arguments for method CreateRegexPatternSet on Paws::WAFRegional
...
As an example:
  ...
  $service_obj->CreateRegexPatternSet(Att1 => $value1, Att2 => $value2, ...);
