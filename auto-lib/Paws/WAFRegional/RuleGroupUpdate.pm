...
Paws::WAFRegional::RuleGroupUpdate
...
As an example, if Att1 is expected to be a Paws::WAFRegional::RuleGroupUpdate object:

  $service_obj->Method(Att1 => { Action => $value, ..., ActivatedRule => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::RuleGroupUpdate object:
