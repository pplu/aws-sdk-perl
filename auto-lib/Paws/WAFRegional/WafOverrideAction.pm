package Paws::WAFRegional::WafOverrideAction;
  use Moose;
...
Paws::WAFRegional::WafOverrideAction
...
As an example, if Att1 is expected to be a Paws::WAFRegional::WafOverrideAction object:

  $service_obj->Method(Att1 => { Type => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFRegional::WafOverrideAction object:
