...
package Paws::SimpleWorkflow::RegisterActivityType;
  ...
  has DefaultTaskHeartbeatTimeout => (is => 'ro', isa => Str, predicate => 1);
  has DefaultTaskList => (is => 'ro', isa => SimpleWorkflow_TaskList, predicate => 1);
  has DefaultTaskPriority => (is => 'ro', isa => Str, predicate => 1);
  has DefaultTaskScheduleToCloseTimeout => (is => 'ro', isa => Str, predicate => 1);
  has DefaultTaskScheduleToStartTimeout => (is => 'ro', isa => Str, predicate => 1);
