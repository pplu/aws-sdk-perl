...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to RespondActivityTaskCompleted.
...
The C<taskToken> is generated by the service and should be treated as
...
This class forms part of L<Paws>, and documents parameters for RespondActivityTaskCompleted in Paws::SimpleWorkflow
