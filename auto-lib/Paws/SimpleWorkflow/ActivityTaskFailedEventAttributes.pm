...
Paws::SimpleWorkflow::ActivityTaskFailedEventAttributes
...
As an example, if Att1 is expected to be a Paws::SimpleWorkflow::ActivityTaskFailedEventAttributes object:

  $service_obj->Method(Att1 => { Details => $value, ..., StartedEventId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SimpleWorkflow::ActivityTaskFailedEventAttributes object:
