...
package Paws::ECS::DescribeContainerInstances {
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'DescribeContainerInstancesResult');
}
1;
...
This class forms part of L<Paws>, and documents parameters for DescribeContainerInstances in Paws::ECS
