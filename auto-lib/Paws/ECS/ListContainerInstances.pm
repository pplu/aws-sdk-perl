...
package Paws::ECS::ListContainerInstances {
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'ListContainerInstancesResult');
}
1;
...
This class forms part of L<Paws>, and documents parameters for ListContainerInstances in Paws::ECS
