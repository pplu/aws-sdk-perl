...
package Paws::S3Control::NoncurrentVersionTransition;
  use Moose;
...
Paws::S3Control::NoncurrentVersionTransition
...
As an example, if Att1 is expected to be a Paws::S3Control::NoncurrentVersionTransition object:

  $service_obj->Method(Att1 => { NoncurrentDays => $value, ..., StorageClass => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::S3Control::NoncurrentVersionTransition object:
