...
package Paws::S3Control::Tagging;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::S3Control::Tagging object:

  $service_obj->Method(Att1 => { TagSet => $value, ..., TagSet => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::S3Control::Tagging object:
