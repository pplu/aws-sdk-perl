...
package Paws::AppSync::CreateGraphqlApi;
  ...
  use Paws::AppSync::Types qw/AppSync_LogConfig AppSync_UserPoolConfig AppSync_TagMap AppSync_AdditionalAuthenticationProvider AppSync_OpenIDConnectConfig/;
