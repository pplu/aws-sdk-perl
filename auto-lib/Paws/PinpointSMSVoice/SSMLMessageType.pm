...
Paws::PinpointSMSVoice::SSMLMessageType
...
As an example, if Att1 is expected to be a Paws::PinpointSMSVoice::SSMLMessageType object:

  $service_obj->Method(Att1 => { LanguageCode => $value, ..., VoiceId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PinpointSMSVoice::SSMLMessageType object:
