...
Paws::ApiGateway::DeleteDocumentationPart - Arguments for method DeleteDocumentationPart on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->DeleteDocumentationPart(Att1 => $value1, Att2 => $value2, ...);
