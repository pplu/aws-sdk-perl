...
package Paws::ApiGateway::DocumentationPart;
  ...
  has Location => (is => 'ro', isa => 'Paws::ApiGateway::DocumentationPartLocation', traits => ['Unwrapped'], xmlname => 'location');
  has Properties => (is => 'ro', isa => 'Str', traits => ['Unwrapped'], xmlname => 'properties');
