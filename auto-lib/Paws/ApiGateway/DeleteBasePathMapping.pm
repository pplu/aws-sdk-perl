...
Paws::ApiGateway::DeleteBasePathMapping - Arguments for method DeleteBasePathMapping on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->DeleteBasePathMapping(Att1 => $value1, Att2 => $value2, ...);
