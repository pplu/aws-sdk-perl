...
Paws::ApiGateway::DeleteRequestValidator - Arguments for method DeleteRequestValidator on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->DeleteRequestValidator(Att1 => $value1, Att2 => $value2, ...);
