package Paws::ApiGateway::MapOfMethodSnapshot;
  ...
  use Paws::ApiGateway::Types qw/ApiGateway_MethodSnapshot/;

  has Map => (is => 'ro', isa => HashRef[ApiGateway_MethodSnapshot]);

  sub params_map {
    our $Params_map ||= {
                    types => {
                               'Map' => {
                                          type => 'HashRef[ApiGateway_MethodSnapshot]',
                                          class => 'Paws::ApiGateway::MethodSnapshot',
                                        },
                             },
                  };
    return $Params_map;
