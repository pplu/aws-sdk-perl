...
Paws::ApiGateway::GetDocumentationPart - Arguments for method GetDocumentationPart on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->GetDocumentationPart(Att1 => $value1, Att2 => $value2, ...);
