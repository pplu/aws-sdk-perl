...
package Paws::ApiGateway::GetDeployments;
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'GetDeploymentsResult');
1;
...
Paws::ApiGateway::GetDeployments - Arguments for method GetDeployments on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->GetDeployments(Att1 => $value1, Att2 => $value2, ...);
