...
package Paws::ApiGateway::GetClientCertificates;
  ...
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'GetClientCertificatesResult');
1;
...
Paws::ApiGateway::GetClientCertificates - Arguments for method GetClientCertificates on Paws::ApiGateway
...
As an example:
  ...
  $service_obj->GetClientCertificates(Att1 => $value1, Att2 => $value2, ...);
