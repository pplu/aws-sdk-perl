...
package Paws::ApplicationCostProfiler::S3Location;
  use Moose;
...
Paws::ApplicationCostProfiler::S3Location
...
As an example, if Att1 is expected to be a Paws::ApplicationCostProfiler::S3Location object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationCostProfiler::S3Location object:
...
AWS Application Cost Profiler reports are generated and then written
to.
