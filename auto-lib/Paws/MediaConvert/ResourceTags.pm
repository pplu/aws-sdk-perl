...
Paws::MediaConvert::ResourceTags
...
As an example, if Att1 is expected to be a Paws::MediaConvert::ResourceTags object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::ResourceTags object:
