package Paws::MediaConvert::__mapOfAudioSelector;
  ...
  use Paws::MediaConvert::Types qw/MediaConvert_AudioSelector/;

  has Map => (is => 'ro', isa => HashRef[MediaConvert_AudioSelector]);

  sub params_map {
    our $Params_map ||= {
                    types => {
                               'Map' => {
                                          type => 'HashRef[MediaConvert_AudioSelector]',
                                          class => 'Paws::MediaConvert::AudioSelector',
                                        },
                             },
                  };
    return $Params_map;
