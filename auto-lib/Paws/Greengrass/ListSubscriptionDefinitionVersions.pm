...
Paws::Greengrass::ListSubscriptionDefinitionVersions - Arguments for method ListSubscriptionDefinitionVersions on Paws::Greengrass
...
As an example:
  ...
  $service_obj->ListSubscriptionDefinitionVersions(Att1 => $value1, Att2 => $value2, ...);
