...
Paws::Greengrass::DeleteCoreDefinition - Arguments for method DeleteCoreDefinition on Paws::Greengrass
...
As an example:
  ...
  $service_obj->DeleteCoreDefinition(Att1 => $value1, Att2 => $value2, ...);
