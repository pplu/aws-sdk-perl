...
Paws::Greengrass::CreateGroupCertificateAuthority - Arguments for method CreateGroupCertificateAuthority on Paws::Greengrass
...
As an example:
  ...
  $service_obj->CreateGroupCertificateAuthority(Att1 => $value1, Att2 => $value2, ...);
