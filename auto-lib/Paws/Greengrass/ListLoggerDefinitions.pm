...
Paws::Greengrass::ListLoggerDefinitions - Arguments for method ListLoggerDefinitions on Paws::Greengrass
...
As an example:
  ...
  $service_obj->ListLoggerDefinitions(Att1 => $value1, Att2 => $value2, ...);
