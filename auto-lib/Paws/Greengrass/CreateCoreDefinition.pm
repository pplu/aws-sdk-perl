...
package Paws::Greengrass::CreateCoreDefinition;
  ...
  use Paws::Greengrass::Types qw/Greengrass_Tags Greengrass_CoreDefinitionVersion/;
  has AmznClientToken => (is => 'ro', isa => Str, predicate => 1);
  has InitialVersion => (is => 'ro', isa => Greengrass_CoreDefinitionVersion, predicate => 1);
...
=head2 InitialVersion => Greengrass_CoreDefinitionVersion
