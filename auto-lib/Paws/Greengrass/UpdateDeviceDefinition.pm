...
Paws::Greengrass::UpdateDeviceDefinition - Arguments for method UpdateDeviceDefinition on Paws::Greengrass
...
As an example:
  ...
  $service_obj->UpdateDeviceDefinition(Att1 => $value1, Att2 => $value2, ...);
