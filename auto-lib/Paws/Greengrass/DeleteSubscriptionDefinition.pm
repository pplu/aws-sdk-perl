...
Paws::Greengrass::DeleteSubscriptionDefinition - Arguments for method DeleteSubscriptionDefinition on Paws::Greengrass
...
As an example:
  ...
  $service_obj->DeleteSubscriptionDefinition(Att1 => $value1, Att2 => $value2, ...);
