...
Paws::Greengrass::AssociateRoleToGroup - Arguments for method AssociateRoleToGroup on Paws::Greengrass
...
As an example:
  ...
  $service_obj->AssociateRoleToGroup(Att1 => $value1, Att2 => $value2, ...);
