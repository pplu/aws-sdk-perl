...
package Paws::Greengrass::CreateSoftwareUpdateJob;
  ...
  has S3UrlSignerRole => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has SoftwareToUpdate => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has UpdateAgentLogLevel => (is => 'ro', isa => Str, predicate => 1);
  has UpdateTargets => (is => 'ro', isa => ArrayRef[Str|Undef], required => 1, predicate => 1);
  has UpdateTargetsArchitecture => (is => 'ro', isa => Str, required => 1, predicate => 1);
  has UpdateTargetsOperatingSystem => (is => 'ro', isa => Str, required => 1, predicate => 1);
  ...
  'IsRequired' => {
                    'S3UrlSignerRole' => 1,
                    'SoftwareToUpdate' => 1,
                    'UpdateTargetsArchitecture' => 1,
                    'UpdateTargetsOperatingSystem' => 1,
                    'UpdateTargets' => 1
                  },
  'types' => {
               'UpdateAgentLogLevel' => {
