...
package Paws::CloudFront::ListDistributionsByWebACLId;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2017-10-30/distributionsByWebACLId/{WebACLId}');
...
This class represents the parameters used for calling the method ListDistributionsByWebACLId2017_10_30 on the 
L<Amazon CloudFront|Paws::CloudFront> service. Use the attributes of this class
as arguments to method ListDistributionsByWebACLId2017_10_30.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListDistributionsByWebACLId2017_10_30.

As an example:

  $service_obj->ListDistributionsByWebACLId2017_10_30(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, documenting arguments for method ListDistributionsByWebACLId2017_10_30 in L<Paws::CloudFront>
