...
This class represents the parameters used for calling the method ListInvalidations2017_10_30 on the
L<Amazon CloudFront|Paws::CloudFront> service. Use the attributes of this class
as arguments to method ListInvalidations2017_10_30.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListInvalidations2017_10_30.

As an example:

  $service_obj->ListInvalidations2017_10_30(Att1 => $value1, Att2 => $value2, ...);

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudfront/ListInvalidations>
...
This class forms part of L<Paws>, documenting arguments for method ListInvalidations2017_10_30 in L<Paws::CloudFront>
