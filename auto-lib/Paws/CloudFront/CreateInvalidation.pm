...
package Paws::CloudFront::CreateInvalidation;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2016-09-07/distribution/{DistributionId}/invalidation');
...
This class represents the parameters used for calling the method CreateInvalidation2016_09_07 on the 
Amazon CloudFront service. Use the attributes of this class
as arguments to method CreateInvalidation2016_09_07.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateInvalidation2016_09_07.

As an example:

  $service_obj->CreateInvalidation2016_09_07(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, documenting arguments for method CreateInvalidation2016_09_07 in L<Paws::CloudFront>
