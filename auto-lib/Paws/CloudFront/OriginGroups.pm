...
As an example, if Att1 is expected to be a Paws::CloudFront::OriginGroups object:

  $service_obj->Method(Att1 => { Items => $value, ..., Quantity => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudFront::OriginGroups object:
