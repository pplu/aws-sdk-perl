...
Paws::RedShift::DescribeTableRestoreStatus - Arguments for method DescribeTableRestoreStatus on Paws::RedShift
...
As an example:
  ...
  $service_obj->DescribeTableRestoreStatus(Att1 => $value1, Att2 => $value2, ...);
