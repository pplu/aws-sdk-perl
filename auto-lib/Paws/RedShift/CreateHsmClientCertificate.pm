...
As an example:
  ...
  $service_obj->CreateHsmClientCertificate(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for CreateHsmClientCertificate in Paws::RedShift
