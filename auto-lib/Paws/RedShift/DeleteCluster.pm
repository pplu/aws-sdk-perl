...
package Paws::RedShift::DeleteCluster;
  ...
  has FinalClusterSnapshotIdentifier => (is => 'ro', isa => Str, predicate => 1);
  has FinalClusterSnapshotRetentionPeriod => (is => 'ro', isa => Int, predicate => 1);
  has SkipFinalClusterSnapshot => (is => 'ro', isa => Bool, predicate => 1);
