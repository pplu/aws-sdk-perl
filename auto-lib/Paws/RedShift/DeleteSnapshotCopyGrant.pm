...
Paws::RedShift::DeleteSnapshotCopyGrant - Arguments for method DeleteSnapshotCopyGrant on Paws::RedShift
...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to DeleteSnapshotCopyGrant.

As an example:

  $service_obj->DeleteSnapshotCopyGrant(Att1 => $value1, Att2 => $value2, ...);
