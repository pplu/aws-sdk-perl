...
Paws::RedShift::CreateClusterSecurityGroup - Arguments for method CreateClusterSecurityGroup on Paws::RedShift
...
As an example:
  ...
  $service_obj->CreateClusterSecurityGroup(Att1 => $value1, Att2 => $value2, ...);
...
This class forms part of L<Paws>, and documents parameters for CreateClusterSecurityGroup in Paws::RedShift
