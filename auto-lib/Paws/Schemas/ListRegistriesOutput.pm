package Paws::Schemas::ListRegistriesOutput;
  use Moose;
...
Paws::Schemas::ListRegistriesOutput
...
As an example, if Att1 is expected to be a Paws::Schemas::ListRegistriesOutput object:

  $service_obj->Method(Att1 => { NextToken => $value, ..., Registries => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::ListRegistriesOutput object:
