...
As an example, if Att1 is expected to be a Paws::Schemas::LockServiceLinkedRoleResponse object:

  $service_obj->Method(Att1 => { CanBeDeleted => $value, ..., RelatedResources => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::LockServiceLinkedRoleResponse object:
