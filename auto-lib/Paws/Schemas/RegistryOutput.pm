package Paws::Schemas::RegistryOutput;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Schemas::RegistryOutput object:

  $service_obj->Method(Att1 => { Description => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::RegistryOutput object:
