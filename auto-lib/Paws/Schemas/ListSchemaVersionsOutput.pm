package Paws::Schemas::ListSchemaVersionsOutput;
  use Moose;
...
Paws::Schemas::ListSchemaVersionsOutput
...
As an example, if Att1 is expected to be a Paws::Schemas::ListSchemaVersionsOutput object:

  $service_obj->Method(Att1 => { NextToken => $value, ..., SchemaVersions => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::ListSchemaVersionsOutput object:
