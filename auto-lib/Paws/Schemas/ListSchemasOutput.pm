package Paws::Schemas::ListSchemasOutput;
  use Moose;
...
Paws::Schemas::ListSchemasOutput
...
As an example, if Att1 is expected to be a Paws::Schemas::ListSchemasOutput object:

  $service_obj->Method(Att1 => { NextToken => $value, ..., Schemas => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::ListSchemasOutput object:
