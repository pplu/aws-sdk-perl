...
You shouln't make instances of this class. Each attribute should be used as a named argument in the call to StartPipelineExecution.

As an example:

  $service_obj->StartPipelineExecution(Att1 => $value1, Att2 => $value2, ...);
