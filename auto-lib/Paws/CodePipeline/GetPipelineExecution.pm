...
Paws::CodePipeline::GetPipelineExecution - Arguments for method GetPipelineExecution on Paws::CodePipeline
...
As an example:
  ...
  $service_obj->GetPipelineExecution(Att1 => $value1, Att2 => $value2, ...);
