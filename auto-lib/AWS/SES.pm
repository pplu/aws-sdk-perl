use MooseX::Declare;
use AWS::API;
class AWS::SES::Body with AWS::API::ResultParser {
  has Html => (is => 'ro', isa => 'AWS::SES::Content');
  has Text => (is => 'ro', isa => 'AWS::SES::Content');
}

class AWS::SES::Content with AWS::API::ResultParser {
  has Charset => (is => 'ro', isa => 'Str');
  has Data => (is => 'ro', isa => 'Str', required => 1);
}

class AWS::SES::Destination with AWS::API::ResultParser {
...
class AWS::SES::IdentityDkimAttributes with AWS::API::ResultParser {
...
class AWS::SES::IdentityNotificationAttributes with AWS::API::ResultParser {
...
class AWS::SES::IdentityVerificationAttributes with AWS::API::ResultParser {
  has VerificationToken => (is => 'ro', isa => 'Str');
  has VerificationStatus => (is => 'ro', isa => 'Str', required => 1);
}

class AWS::SES::Message with AWS::API::ResultParser {
...
class AWS::SES::RawMessage with AWS::API::ResultParser {
  has Data => (is => 'ro', isa => 'Str', required => 1);
}

class AWS::SES::SendDataPoint with AWS::API::ResultParser {
...
class AWS::SES::GetSendQuotaResult with AWS::API::ResultParser {
  has Max24HourSend => (is => 'ro', isa => 'Int');
  has SentLast24Hours => (is => 'ro', isa => 'Int');
  has MaxSendRate => (is => 'ro', isa => 'Int');
}
...
class AWS::SES with AWS::API::Caller with AWS::API::RegionalEndpointCaller {
  ...
  method VerifyEmailAddress (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SES::VerifyEmailAddressResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method DeleteVerifiedEmailAddress (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SES::DeleteVerifiedEmailAddressResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
