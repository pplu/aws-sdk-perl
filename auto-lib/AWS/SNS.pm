use MooseX::Declare;
use AWS::API;
class AWS::SNS::Attributes with AWS::API::MapParser {
}

class AWS::SNS::Endpoint with AWS::API::ResultParser {
  has Attributes => (is => 'ro', isa => 'AWS::SNS::Attributes');
  has EndpointArn => (is => 'ro', isa => 'Str');
}

class AWS::SNS::PlatformApplication with AWS::API::ResultParser {
  has PlatformApplicationArn => (is => 'ro', isa => 'Str');
  has Attributes => (is => 'ro', isa => 'AWS::SNS::Attributes');
}

class AWS::SNS::Subscription with AWS::API::ResultParser {
...
class AWS::SNS::Topic with AWS::API::ResultParser {
  has TopicArn => (is => 'ro', isa => 'Str');
}
...
class AWS::SNS::SetPlatformApplicationAttributes {
  ...
  has Attributes => (is => 'ro', isa => 'AWS::SNS::Attributes', required => 1);
...
class AWS::SNS with AWS::API::Caller {
  ...
  method SetSubscriptionAttributes (%args) {
    ...
    my $o_result = AWS::SNS::SetSubscriptionAttributesResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method RemovePermission (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::RemovePermissionResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method SetPlatformApplicationAttributes (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::SetPlatformApplicationAttributesResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method DeletePlatformApplication (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::DeletePlatformApplicationResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method Unsubscribe (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::UnsubscribeResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method AddPermission (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::AddPermissionResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method SetTopicAttributes (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::SetTopicAttributesResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method DeleteEndpoint (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::DeleteEndpointResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method SetEndpointAttributes (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::SetEndpointAttributesResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
  ...
  method DeleteTopic (%args) {
    ...
    my $result = $self->_api_caller($call->_api_call, $call);
    my $o_result = AWS::SNS::DeleteTopicResult->from_result($result->{ $call->_result_key });
    return $o_result;
  }
