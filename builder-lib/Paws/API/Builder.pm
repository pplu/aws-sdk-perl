package Paws::API::Builder {
  ...
  has signature_role => (
    ...
    default => sub {
      my $self = shift;
      my $signature_type = $self->api_struct->{metadata}{signatureVersion};
      sprintf "Paws::Net::%sSignature", ucfirst $signature_type;
    } 
  );
  ...
  has parameter_role => (
    ...
    default => sub {
      ...
      return sprintf "Paws::Net::%sCaller", ucfirst $type;
    },
  );
