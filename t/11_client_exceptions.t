...
throws_ok {
  $p->service('EC2', region => 'eu-west-1', caller => $caller, credentials => $creds)->DescribeInstances;
...
throws_ok {
  $p->service('SQS', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListQueues;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('IAM', caller => $caller, credentials => $creds)->ListUsers;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('DynamoDB', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListTables;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('S3', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListBuckets;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('Route53', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListHostedZones;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('SDB', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListDomains;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('CloudWatchLogs', region => 'eu-west-1', caller => $caller, credentials => $creds)->DescribeLogGroups;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('Lambda', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListFunctions;
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('Glacier', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListVaults(accountId => 'X');
} 'Paws::Exception', 'got exception';
...
throws_ok {
  $p->service('CloudSearch', region => 'eu-west-1', caller => $caller, credentials => $creds)->ListDomainNames;
} 'Paws::Exception', 'got exception';
